---
title: "Overview"
description: "At Unleash, we prioritize the privacy and security of our customers' data. Our  ensures privacy by evaluating feature flags locally within the  or , meaning no user data is shared with the Unleash instance."
---
...
### Version and instance ID[​](#version-and-instance-id "Direct link to Version and instance ID")
...
### Feature usage data[​](#feature-usage-data "Direct link to Feature usage data")
...
## Manage data collection settings[​](#manage-data-collection-settings "Direct link to Manage data collection settings")
...
### Disable all telemetry[​](#disable-all-telemetry "Direct link to Disable all telemetry")
...
### Disable feature telemetry[​](#disable-feature-telemetry "Direct link to Disable feature telemetry")
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/understanding-unleash/data-collection.md)

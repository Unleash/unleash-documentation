---
title: "Core concepts"
description: "This guide's purpose is to give you a conceptual overview of how Unleash works. It covers the various components that exist within our system and how they interact with each other and with external applications. The diagrams help you understand the fundamental building blocks, such as , ,  and of course, ."
---
...
## The root level[​](#the-root-level "Direct link to The root level")
...
![Unleash projects contain one or more environments](../images/understanding-unleash/assets/images/anatomy-of-unleash-environment-a51ce93daa041f0ca1e41e269d625884.png)

## Environments and project environments[​](#environments-and-project-environments "Direct link to Environments and project environments")

![Activating feature flags in environments](../images/understanding-unleash/assets/images/anatomy-of-unleash-customer-tiers-de9282ccfd58965bdd2d7d07515ad70b.png)
...
![Constraints and activation strategies](../images/understanding-unleash/assets/images/anatomy-of-unleash-new-feature-rollout-448331b7984a97894ab3edb1a64feea8.png)
...
## Features (feature flags)[​](#features-feature-flags "Direct link to Features (feature flags)")
...
![A project containing an environment containing a feature flag configuration](../images/understanding-unleash/assets/images/anatomy-of-unleash-features-3637fadbe2e41e68c18162bde9b9f5dd.png)

## Activation strategies[​](#activation-strategies "Direct link to Activation strategies")

![An environment containing a feature flag configuration with an activation strategy](../images/understanding-unleash/assets/images/anatomy-of-unleash-strategy-03ead043c7db3c44c7021aae7749b7a0.png)
...
![Feature flags across environments with different activation strategies](../images/understanding-unleash/assets/images/anatomy-of-unleash-environments-strategies-ae4bec6c827caac3616219d3c47117be.png)

![Copying activation strategies](../images/understanding-unleash/assets/images/anatomy-of-unleash-environments-strategies2-b9269bae9a4d5e0ebebda0b114344ae4.png)

## Strategy constraints[​](#strategy-constraints "Direct link to Strategy constraints")
...
![Example of constraints applied to strategies](../images/understanding-unleash/assets/images/anatomy-of-unleash-constraint-c9ba9f6d669cd1d60abf42e20947e720.png)
...
![An example of segments](../images/understanding-unleash/assets/images/anatomy-of-unleash-segments-1f4ddc5bf8d231b12f6c47bcbdc07904.png)

## Variants and feature flag payloads[​](#variants-and-feature-flag-payloads "Direct link to Variants and feature flag payloads")
...
### Variants and environments[​](#variants-and-environments "Direct link to Variants and environments")
...
![Variants prior to Unleash 4.21](../images/understanding-unleash/assets/images/anatomy-of-unleash-variants-2f5bc23be7770a4c845cac8df1643994.png)
...
![Variants after version 4.21](../images/understanding-unleash/assets/images/anatomy-of-unleash-variants-environment-98ae2f2deedd43e15d865253cacd4c87.png)

## Use case: changing website colors[​](#use-case "Direct link to Use case: changing website colors")
...
### Configuring Unleash for development[​](#configuring-unleash-for-development "Direct link to Configuring Unleash for development")
...
### In your application[​](#in-your-application "Direct link to In your application")
...
```
if (unleash.isEnabled(“new-color-scheme”)) {  // load stylesheet with the new color scheme} else {  // load stylesheet with the old color scheme}
```
...
### Rolling out the feature to users[​](#rolling-out-the-feature-to-users "Direct link to Rolling out the feature to users")
...
### Adding variants[​](#adding-variants "Direct link to Adding variants")
...
```
const theme = unleash.getVariant(“new-color-scheme”).name;if (theme === “green”) {  // load stylesheet with green color scheme} else if (theme === “blue”) {  // load stylesheet with blue color scheme} else if (theme === “purple”) {  // load stylesheet with purple color scheme} else {  // load stylesheet with old color scheme}
```
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/understanding-unleash/the-anatomy-of-unleash.mdx)

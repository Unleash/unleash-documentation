...
<CardGroup>
  <Card title="Get lifecycle trends!" href="/api-reference/admin-ui/get-lifecycle-trends" icon="user-lock">
    [Unleash Enterprise](/openapi-static/Enterprise.svg) **Enterprise feature**
  </Card>
  <Card title="Send Unleash feedback" href="/api-reference/admin-ui/create-feedback" icon="user-lock">
  ...
  <Card title="Get UI configuration" href="/api-reference/admin-ui/get-ui-config" icon="user-lock">
    Retrieves the full configuration used to set up the Unleash Admin UI.
    
  </Card>

  <Card title="Sets allowed CORS origins" href="/api-reference/admin-ui/set-cors" icon="user-lock">
    Sets Cross-Origin Resource Sharing headers for Frontend SDK API.

  </Card>

  <Card title="Update Unleash feedback" href="/api-reference/admin-ui/update-feedback" icon="user-lock">
  ...
  <Card title="Update splash settings" href="/api-reference/admin-ui/update-splash-settings" icon="user-lock">
    This operation updates splash settings for a user, indicating that they have seen a particualar splash screen.
    
  </Card>

  <Card title="Accepts errors from the UI client" href="/api-reference/admin-ui/ui-observability" icon="user-lock">

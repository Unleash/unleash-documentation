...
<CardGroup col={2}>
  <Card title="Get API tokens" href="/api-reference/api-tokens/get-all-api-tokens" icon="code">
    Retrieves all API tokens that exist in the Unleash instance.
  </Card>

  <Card title="Create API token" href="/api-reference/api-tokens/create-api-token" icon="code">
    Create an API token of a specific type: one of client, admin, frontend, backend.
  </Card>

  <Card title="Get API tokens by name" href="/api-reference/api-tokens/get-api-tokens-by-name" icon="code">
  ...
  <Card title="Update API token" href="/api-reference/api-tokens/update-api-token" icon="code">
  ...
  <Card title="Delete API token" href="/api-reference/api-tokens/delete-api-token" icon="code">

...
title: "Login history"
---
<Badge intent="success">v4.22</Badge> <Badge intent="info" minimal>Enterprise</Badge>
...
## Download login history[​](#download-login-history "Direct link to Download login history")

To download the login history, go to the login history page and click **Download login history**.

[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/reference/login-history.mdx)

---
title: "Command-Line Help for"
---

<Info>
  This document was generated from docs/CLI.md in the [Unleash Edge GitHub repository](https://github.com/Unleash/unleash-edge).
</Info>
...
## `unleash-edge edge`[​](#unleash-edge-edge "Direct link to unleash-edge-edge")
...
## `unleash-edge offline`[​](#unleash-edge-offline "Direct link to unleash-edge-offline")
...
## `unleash-edge health`[​](#unleash-edge-health "Direct link to unleash-edge-health")
...
## `unleash-edge ready`[​](#unleash-edge-ready "Direct link to unleash-edge-ready")
...
[Edit this page](https://github.com/Unleash/unleash-edge/edit/main/docs/CLI.md)

---
title: "Migrating from the Unleash Proxy to Edge"
---

<Info>
  This document was generated from docs/migration-guide.md in the [Unleash Edge GitHub repository](https://github.com/Unleash/unleash-edge).
</Info>
...
A full [Docker compose file](https://github.com/Unleash/unleash-edge/blob/main/../examples/docker-compose.yml) is also provided. It will spin up Edge, Unleash, and Redis, to allow you to understand the configuration options in context.
...
## Legacy proxy tokens[​](#legacy-proxy-tokens "Direct link to Legacy proxy tokens")

With Edge 19.10.0 we introduced a new concept in Edge that aims to support this functionality. For reference, check the readme file: [https://github.com/Unleash/unleash-edge?tab=readme-ov-file#pretrusted-tokens](https://github.com/Unleash/unleash-edge?tab=readme-ov-file#pretrusted-tokens)
...
* Legacy proxy Tokens ([now supported](https://github.com/Unleash/unleash-edge?tab=readme-ov-file#pretrusted-tokens) from edge version 19.10.0). If you're using the proxy, you may be using the legacy proxy token format. These are not supported in Edge. You will need to create a new front end SDK token in the Unleash UI and use that. These are the same tokens that the front end API requires. Because of the way Edge handles API tokens, this is not a feature we're planning to support.
...
## Existing features in new ways[​](#existing-features-in-new-ways "Direct link to Existing features in new ways")
...
## Existing features with new configuration options[​](#existing-features-with-new-configuration-options "Direct link to Existing features with new configuration options")
...
## Why choose Unleash Edge over the Unleash Proxy?[​](#why-choose-unleash-edge-over-the-unleash-proxy "Direct link to Why choose Unleash Edge over the Unleash Proxy?")
...
[Edit this page](https://github.com/Unleash/unleash-edge/edit/main/docs/migration-guide.md)

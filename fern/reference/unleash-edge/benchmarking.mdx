...
<Info>
  This document was generated from docs/benchmarking.md in the [Unleash Edge GitHub repository](https://github.com/Unleash/unleash-edge).
</Info>
...
### Large Dataset (350 features (100kB))[​](#large-dataset-350-features-100kb "Direct link to Large Dataset (350 features (100kB))")
...
### Small Dataset (5 features (2kB))[​](#small-dataset-5-features-2kb "Direct link to Small Dataset (5 features (2kB))")
...
[Edit this page](https://github.com/Unleash/unleash-edge/edit/main/docs/benchmarking.md)

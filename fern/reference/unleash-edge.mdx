...
<Info>
  This document was generated from README.md in the [Unleash Edge GitHub repository](https://github.com/Unleash/unleash-edge).
</Info>

<p style="margin: 0; padding: 0;"><a href="https://crates.io/crates/unleash-edge"><img src="https://img.shields.io/crates/v/unleash-edge" alt="crates.io" style="margin: 0; padding: 0; display: inline-block;" /></a> <a href="https://docs.rs/unleash-edge/latest"><img src="https://docs.rs/unleash-edge/badge.svg" alt="Documentation" style="margin: 0; padding: 0; display: inline-block;" /></a> <a href="https://github.com/Unleash/unleash-edge/blob/main/LICENSE"><img src="https://img.shields.io/crates/l/unleash-edge" alt="MIT licensed" style="margin: 0; padding: 0; display: inline-block;" /></a> <a href="https://deps.rs/crate/unleash-edge/19.11.0"><img src="https://deps.rs/crate/unleash-edge/19.11.0/status.svg" alt="Dependency Status" style="margin: 0; padding: 0; display: inline-block;" /></a> <a href="https://github.com/Unleash/unleash-edge/actions/workflows/test-with-coverage.yaml"><img src="https://github.com/Unleash/unleash-edge/actions/workflows/test-with-coverage.yaml/badge.svg" alt="CI" style="margin: 0; padding: 0; display: inline-block;" /></a> <a href="https://coveralls.io/github/Unleash/unleash-edge?branch=main"><img src="https://coveralls.io/repos/github/Unleash/unleash-edge/badge.svg" alt="Coverage Status" style="margin: 0; padding: 0; display: inline-block;" /></a> <img src="https://img.shields.io/crates/d/unleash-edge" alt="downloads" style="margin: 0; padding: 0; display: inline-block;" /></p>
...
You can run Edge in two different modes: **edge** or **offline**. To learn about the different modes and other Edge concepts, visit [Concepts](https://github.com/Unleash/unleash-edge/blob/main/docs/concepts.md).

Unleash Edge is the successor to Unleash Proxy. For help with migrating from Proxy to Edge, refer to the [migration guide](https://github.com/Unleash/unleash-edge/blob/main/docs/migration-guide.md).
...
## Versioning and availability[​](#versioning-and-availability "Direct link to Versioning and availability")
...
## Getting Unleash Edge[​](#getting-unleash-edge "Direct link to Getting Unleash Edge")

Unleash Edge is distributed as a binary and as a Docker image.

* **Binary**:

  * Downloadable from our [Releases page](https://github.com/Unleash/unleash-edge/releases/latest). Available for Linux x86\_64, Windows x86\_64, Darwin (OS X) x86\_64, and Darwin (OS X) aarch64 (M1/M2 Macs).
...
## Running Unleash Edge[​](#running-unleash-edge "Direct link to Running Unleash Edge")

The `docker run` command supports the same [CLI arguments](https://github.com/Unleash/unleash-edge/blob/main/docs/CLI.md) that are available when running a binary.
...
### Tokens in edge mode[​](#tokens-in-edge-mode "Direct link to Tokens in edge mode")
...
### Client and frontend tokens in offline mode[​](#client-and-frontend-tokens-in-offline-mode "Direct link to Client and frontend tokens in offline mode")
...
### Pretrusted tokens[​](#pretrusted-tokens "Direct link to Pretrusted tokens")
...
You can provide pretrusted tokens using either the --pretrusted-tokens CLI flag or the PRETRUSTED\_TOKENS environment variable.
...
### Edge concepts[​](#edge-concepts "Direct link to Edge concepts")

To learn more about Unleash Edge, see the [Concepts](https://github.com/Unleash/unleash-edge/blob/main/docs/concepts.md) documentation.

### CLI[​](#cli "Direct link to CLI")

For a list of available command-line arguments, see [CLI](https://github.com/Unleash/unleash-edge/blob/main/docs/CLI.md).

### Deploying Edge[​](#deploying-edge "Direct link to Deploying Edge")

For deployment instructions, see our [Deploying Edge](https://github.com/Unleash/unleash-edge/blob/main/docs/deploying.md) guide.

### Migrating from Unleash Proxy[​](#migrating-from-unleash-proxy "Direct link to Migrating from Unleash Proxy")

To migrate from the Unleash Proxy to Unleash Edge, refer to the [migration guide](https://github.com/Unleash/unleash-edge/blob/main/docs/migration-guide.md).

### Performance benchmarking[​](#performance-benchmarking "Direct link to Performance benchmarking")

For performance benchmarking, see our [Benchmarking](https://github.com/Unleash/unleash-edge/blob/main/docs/benchmarking.md) page.

### Contribution and development guide[​](#contribution-and-development-guide "Direct link to Contribution and development guide")

See our [Contributors guide](https://github.com/Unleash/unleash-edge/blob/main/CONTRIBUTING.md) as well as our [development-guide](https://github.com/Unleash/unleash-edge/blob/main/docs/development-guide.md).

***

This content was generated on 23 September 2025 at 10:33:41 Coordinated Universal Time

[Edit this page](https://github.com/Unleash/unleash-edge/edit/main/README.md)

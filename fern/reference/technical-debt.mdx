...
## Stale and potentially stale flags[​](#stale-and-potentially-stale-flags "Direct link to Stale and potentially stale flags")

A feature flag can have one of the following states: *active*, *potentially stale*, or *stale*. Unleash marks all flags as potentially stale automatically once they pass their [expected lifetime](/reference/feature-toggles#feature-flag-types). This gives you an indication of when to review and clean up a feature flag in code.
...
![Mark a flag as stale in a project](../images/reference/assets/images/stale-flag-project-8ac3255a8f70c5ef8654236417fb9d01.png)
...
## Project status[​](#project-status "Direct link to Project status")
...
![Project status dashboard](../images/reference/assets/images/project-status-0da3cd8a636554d182ddb83392ff20ce.png)

[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/reference/technical-debt.md)

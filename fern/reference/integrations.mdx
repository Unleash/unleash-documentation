...
## Official integrations[​](#official-integrations "Direct link to Official integrations")
...
## Deprecated integrations[​](#deprecated-integrations "Direct link to Deprecated integrations")
...
## Community integrations[​](#community-integrations "Direct link to Community integrations")
...
### Viewing integration events[​](#viewing-integration-events "Direct link to Viewing integration events")
...
![Icon representing the latest integration event for a specific integration configuration.](../images/reference/assets/images/integration-events-latest-f7837da6dfffd0a7eb2ba31ee33ab279.png)
...
![Integration events view, with the sorted list on the left side and the detailed view on the right side.](../images/reference/assets/images/integration-events-list-details-eb2796f97e0f4bebfeb7f21d483c5db6.png)
...
## Integration pages[​](#integration-pages "Direct link to Integration pages")

<CardGroup>
  <Card title="📄️DatadogVersion: 4.0+" href="/reference/integrations/datadog">
    ##
  </Card>
</CardGroup>

<CardGroup>
  <Card title="🗃️Jira server2 items" href="/reference/integrations/jira-server-plugin-installation">
    ##
  </Card>
</CardGroup>

<CardGroup>
  <Card title="🗃️Jira cloud2 items" href="/reference/integrations/jira-cloud-plugin-installation">
    ##
  </Card>
</CardGroup>

<CardGroup>
  <Card title="📄️App for SlackVersion: 5.5+" href="/reference/integrations/slack-app">
    ##
  </Card>
</CardGroup>

<CardGroup>
  <Card title="📄️Microsoft TeamsVersion: 4.0+" href="/reference/integrations/teams">
    ##
  </Card>
</CardGroup>

<CardGroup>
  <Card title="📄️WebhookVersion: 3.11+" href="/reference/integrations/webhook">
    ##
  </Card>
</CardGroup>

<CardGroup>
  <Card title="📄️TerraformSet up and configure your Unleash instance using infastructure as code." href="/reference/terraform">
    ##
  </Card>
</CardGroup>

[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/reference/integrations/integrations.mdx)

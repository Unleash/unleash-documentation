...
## API token types[​](#api-token-types "Direct link to API token types")

### Backend tokens[​](#backend-tokens "Direct link to Backend tokens")
...
### Frontend tokens[​](#frontend-tokens "Direct link to Frontend tokens")

Use frontend tokens for connecting [frontend SDKs](/reference/sdks#frontend-sdks) to Unleash using the [Unleash Frontend API](/reference/front-end-api) or [Unleash Edge](/reference/unleash-edge). They grant the user permission to:
...
### Service account tokens[​](#service-account-tokens "Direct link to Service account tokens")
...
### Admin tokens[​](#admin-tokens "Direct link to Admin tokens")
...
## API token permissions[​](#api-token-permissions "Direct link to API token permissions")
...
## API token format[​](#api-token-format "Direct link to API token format")
...
## Create an API token[​](#create-an-api-token "Direct link to Create an API token")
...
## Connect a frontend SDK to Unleash using Edge[​](#connect-a-frontend-sdk-to-unleash-using-edge "Direct link to Connect a frontend SDK to Unleash using Edge")
...
![Diagram showing the types of tokens needed to connect a frontend SDK with Edge, and Edge with Unleash](../images/reference/assets/images/sdk-token-example-684fe26c1a8b994642abdf76eaa26088.jpg)

## Proxy client keys[​](#proxy-client-keys "Direct link to Proxy client keys")
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/reference/api-tokens-and-client-keys.mdx)

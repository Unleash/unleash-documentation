...
An **application** is any service that sends requests to the [Unleash Client API](/reference/api/unleash/client), the [Unleash Frontend API](/reference/front-end-api), the Unleash Admin API, or any other API that Unleash exposes. This includes [Unleash SDKs](/reference/sdks), [Unleash Edge](/reference/unleash-edge), the [Unleash proxy](/reference/unleash-proxy), and even the Admin UI.

In the Admin UI, you can access Applications in **Configure > Applications**.

## Application overview[​](#application-overview "Direct link to Application overview")
...
![Application overview](../images/reference/assets/images/application-overview-25a5d85ba60e289bcae49132be807b0e.png)

## Connected instances[​](#connected-instances "Direct link to Connected instances")
...
![Connected instances](../images/reference/assets/images/application-connected-instances-55b915f389c0bebd55fd2d3b6363bae8.png)

## Project applications[​](#project-applications "Direct link to Project applications")
...
![Project applications](../images/reference/assets/images/project-applications-f366471dccd9f54d4ca7ac8b2481012f.png)

[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/reference/applications.mdx)

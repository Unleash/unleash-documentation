...
We redesigned how you add [activation strategies](/concepts/activation-strategies) to flags. The new flow makes it easier to access standard strategies and reusable [release templates](/concepts/release-templates).
When you configure a flag in an environment, click Add strategy and choose one of the following options:
- The [project's default strategy](/concepts/activation-strategies#default-strategy)
- A [standard strategy](/concepts/activation-strategies#standard-strategies), such as gradual rollout or on/off
- An [advanced strategy](/concepts/activation-strategies#advanced-strategies), such as IP or host targeting
- A [release template](/concepts/release-templates)
- A [custom activation strategy](/concepts/custom-activation-strategies) defined in your instance
...
We've added two new widgets to the [Analytics](/concepts/insights) dashboard: **New flags in production** and **Flags archived vs flags created**.

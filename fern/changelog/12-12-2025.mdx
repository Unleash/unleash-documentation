...
We extended the observability dashboard for [Unleash Enterprise Edge](https://docs.getunleash.io/unleash-edge). The dashboard provides visibility into the health and performance of your hosted or self-hosted Enterprise Edge nodes directly within the Unleash Admin UI.
...
We recommend that all OSS users of Edge migrate to [Enterprise Edge](https://docs.getunleash.io/unleash-edge#how-to-get-enterprise-edge) to ensure continued support and access to security updates.

### Global change request overview

We added a global overview for [change requests](https://docs.getunleash.io/concepts/change-requests). The table allows you to view all your open and closed change requests in a single location.

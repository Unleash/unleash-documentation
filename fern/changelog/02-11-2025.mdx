...
Since Unleash v6.0, we've had soft limits in place warning self-hosted Enterprise instances operating without a [valid license](/deploy/license-keys) or exceeding their seat count.

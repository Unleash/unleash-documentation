...
description: "Secure feature flags with Unleash: configure SSO, SCIM, RBAC, CORS, IP allow lists, change requests, and audit logs."
keywords: feature, flag, security, feature flags, unleash
...
<Frame background="subtle">
  ![A diagram showing how Unleash integrates with authentication providers and identity providers.](/assets/sso-idp-auth-provider.jpg)
</Frame>
...
<Frame background="subtle">
  ![The diagram showing the relationship between root roles and project roles in Unleash.](/assets/root-and-project-roles-comparison.jpg)
</Frame>

One of the key responsibilities of the Admin role is assigning users as project Owners and Members. You can also automate this process within your organization by using [Terraform](/integrate/terraform).
...
<Frame background="subtle">
  ![An image of a CORS section in Unleash Admin UI for adding domains that can connect to Unleash Frontend API.](/assets/use-case-security-cors.png)
</Frame>
...
<Frame background="subtle">
  ![An image of Unleash security & compliance review on Vanta Trust Center](/assets/use-case-vanta-trust-center.png)
</Frame>

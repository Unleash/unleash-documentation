...
To archive a flag in Unleash, see [Archive a feature flag](/concepts/feature-flags#archive-a-feature-flag). The [feature flag lifecycle](/concepts/feature-flags#feature-flag-lifecycle) helps you identify flags that are ready for cleanup.

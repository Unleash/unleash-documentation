...
description: "Set up Unleash Edge locally to reduce feature flag latency, connect SDKs, configure tokens, and verify your setup."
keywords: unleash, edge, quickstart
og:site_name: "Unleash Documentation"
og:title: "Unleash Edge quickstart"
max-toc-depth: 3
...
<Tabs>
  ...
  <Tab title="GitHub Release installer">
  ...
  <Tab title="Rust toolchain" language="shell">
  ...
  <Tab title="Docker" language="shell">
    ...
    docker run -it \
      ...
      unleashorg/unleash-edge-enterprise:<version> \
      edge
    ```

    <Info>

    Replace `<version>` with the Enterprise Edge version you want to run.

    You can pick a specific version from the list of [tags on Docker Hub](https://hub.docker.com/r/unleashorg/unleash-edge-enterprise).
  ...
  <Tab title="Docker Compose" language="shell">
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    <Tabs>
      ...
      <Tab title="Solution 1: use host.docker.internal">
      ...
      <Tab title="Solution 2: use a custom network" language="shell">
...
<Tabs>
  ...
  <Tab title="Docker Compose" language="yaml">
...
<Tabs>
  ...
  <Tab title="Java" language="java">
    ...
    ```java {2-3} title="src/main/java/Main.java"
  ...
  <Tab title="JavaScript" language="javascript">
    ...
    ```javascript {2-3} title="src/index.js"
  ...
  <Tab title="Next.js" language="text">
  ...
  <Tab title="Node.js" language="text">
  ...
  <Tab title="Python" language="text">

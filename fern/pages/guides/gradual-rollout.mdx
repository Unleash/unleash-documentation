...
description: "Learn how to perform gradual rollouts with Unleash: create feature flags, target users, add constraints, and monitor releases."
keywords: perform, gradual, rollout, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to perform a gradual rollout"
max-toc-depth: 3
...
<Frame background="subtle">
  ![Create a new feature flag in Unleash.](/assets/react-tutorial-create-new-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Create a feature flag by filling out the form fields.](/assets/react-tutorial-create-flag-form.png)
</Frame>
...
<Frame background="subtle">
  ![Enable the development environment for your feature flag for use in your application.](/assets/tutorial-enable-dev-env.png)
</Frame>
...
<Frame background="subtle">
  ![Image of a gradual rollout form in Unleash](/assets/tutorial-grad-rollout-form.png)
</Frame>
...
<Frame background="subtle">
  ![This diagram breaks down how strategy constraints sit on top activation strategies for flags in Unleash.](/assets/tutorial-building-blocks-strategy-constraints.png)
</Frame>
...
<Frame background="subtle">
  ![You can configure your strategy constraints in the gradual rollout form.](/assets/tutorial-constraints-form.png)
</Frame>
...
<Frame background="subtle">
  ![The anatomy of an Unleash segment in relation to a flag and associated strategy.](/assets/anatomy-of-unleash-segments.png)
</Frame>
...
<Frame background="subtle">
  ![In the top navigation menu in Unleash, go to Configure and then 'Segments' to manage your segments.](/assets/segments.png)
</Frame>
...
[Unleash metrics] are a great way to understand user traffic. With your application using feature flags, you can review:
...
<Frame background="subtle">
  ![Events for a feature flag. The Event log tab is highlighted and the UI shows the most recent changes, including a JSON diff and the change details.](/assets/unleash-toggle-history.png)
</Frame>

...
keywords: managing, constraints, unleash, guide
og:site_name: "Unleash Documentation"
og:title: "Managing constraints"
description: "Manage large Unleash constraints: reduce feature flag data, improve SDK performance, use context fields, and external stores."
max-toc-depth: 3
...
This is also why Unleash caps the number of constraints per strategy and the number of values per constraint; see [Resource limits](/concepts/resource-limits) for the exact limits for your plan.

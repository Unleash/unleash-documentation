...
description: In our Django feature flag tutorial, we implemented a simple feature flag that could be turned on and off. In the real world, many feature flag use cases h
keywords: django, feature, flag, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "Django Feature Flag Examples"
max-toc-depth: 3
---
...
Also, learn more about our API for creating a new strategy for your flag.

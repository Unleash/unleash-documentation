...
description: "Implement feature flags in plain JavaScript with Unleash: run locally, create a flag, add the Browser SDK, and toggle UI."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in JavaScript"
max-toc-depth: 3
...
<Frame background="subtle">
  ![architecture diagram for our implementation](/assets/javascript-guide-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![Create a new feature flag](/assets/go-new-feature-flag.png)
</Frame>
...
<html lang="en">
    ...
    <body>
        <main>
            ...
            <Frame background="subtle">
  <img id="corgi-img" src="/assets/#" alt="Adorable Corgi" />
</Frame>
...
<Frame background="subtle">
  ![A non-functional website with only a button and a notice box](/assets/javascript-guide-template.png)
</Frame>
...
<Frame background="subtle">
  ![Our mini corgi website](/assets/javascript-guide-corgi-site.png)
</Frame>

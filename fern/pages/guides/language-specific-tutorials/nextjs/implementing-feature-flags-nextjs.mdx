...
description: "Learn how to implement feature flags in a Next.js application using the Unleash React SDK to toggle features without redeploying."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Next.js using Unleash"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Next.js Feature Flag Architecture Diagram](/assets/nextjs-feature-flag-architecture-diagram-blog.png)
</Frame>
...
<Frame background="subtle">
  ![Create a new feature flag in Unleash](/assets/create-new-flag-nextjs.png)
</Frame>
...
<Frame background="subtle">
  ![Gradual Rollout](/assets/gradual-rollout-nextjs.png)
</Frame>

The activity is displayed:

<Frame background="subtle">
  ![Activity Successful](/assets/activity-success-nextjs.png)
</Frame>

If we turn it off:

<Frame background="subtle">
  ![Turn flag Off](/assets/gradual-rollout-nextjs-1.png)
</Frame>

No activity is displayed:

<Frame background="subtle">
  ![Activity Successful](/assets/activity-success-nextjs-1.png)
</Frame>

...
description: In our iOS feature flag tutorial, we implemented a simple feature flag that could be turned on and off. In the real world, many feature flag use cases have mo
keywords: feature, flag, examples, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "iOS Feature Flag Examples"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Configure your gradual rollout strategy with a constraint.](/assets/react-ex-grad-rollout-edit.png)
</Frame>

This will take you to the gradual rollout form. Click on the ‘Add constraint’ button.

<Frame background="subtle">
  ![You can add a constraint to your flag in the constraints form.](/assets/react-ex-add-constraint-btn.png)
</Frame>
...
<Frame background="subtle">
  ![A constraint form has a context field and operator with options to base your context field off of.](/assets/react-ex-constraint-form.png)
</Frame>
...
<Frame background="subtle">
  ![The form allows you to configure your variant.](/assets/ios-tutorial-variants-form.png)
</Frame>
...
<Frame background="subtle">
  ![Editing the feature flag settings in Unleash.](/assets/ios-tutorial-edit-settings.png)
</Frame>
...
<Frame background="subtle">
  ![Enabling impression data for a feature flag.](/assets/ios-tutorial-enable-impression-data.png)
</Frame>
...
<Frame background="subtle">
  ![We have a Metrics graph in Unleash to review flag exposure and request rates.](/assets/react-ex-metrics.png)
</Frame>
...
<Frame background="subtle">
  ![Feature flag events showing that the flag's variants have been updated.](/assets/ios-ex-event-logs.png)
</Frame>
...
<Frame background="subtle">
  ![Change request configuration page under project settings.](/assets/react-ex-project-settings.png)
</Frame>
...
<Frame background="subtle">
  ![Change request waiting for approval. Disables flag CR-toggle-3.](/assets/react-ex-change-requests.png)
</Frame>

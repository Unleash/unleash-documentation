...
description: Learn how to implement feature flags in Python with Unleash, Flask, Docker, API tokens, SDK setup, and flag toggles.
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Python"
max-toc-depth: 3
...
<Frame background="subtle">
  ![A screenshot of the Flask Surveys Container App](/assets/python-tutorial-survey-example.png)
</Frame>
...
<iframe src="https://www.youtube-nocookie.com/embed/-Rf0y2Gq8OA?si=udl3eIE9DdxQYGAY" width="100%" height="450px" frameBorder="0" allowFullScreen></iframe>
...
<Frame background="subtle">
  ![An architectural diagram of our Python app using Unleash feature flags](/assets/python-flask-unleash-architecture.png)
</Frame>
...
<Frame background="subtle">
  ![Image of the Unleash platform to create a new feature flag](/assets/tutorial-create-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Image of a feature flag form](/assets/python-tutorial-feature-flag-form.png)
</Frame>
...
<Frame background="subtle">
  ![Image of the enabled Python flag in development environment](/assets/python-tutorial-enabled-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Image of the API token button in API Access view](/assets/tutorial-create-api-token.png)
</Frame>
...
<Frame background="subtle">
  ![Image of the API token creation form](/assets/tutorial-create-api-token.png)
</Frame>
...
<Frame background="subtle">
  ![Image of Surveys app loaded in browser](/assets/python-tutorial-surveys-app-loaded.png)
</Frame>
...
<Frame background="subtle">
  ![Screenshot of app in browser with delete buttons in survey table](/assets/python-tutorial-surveys-with-delete.png)
</Frame>
...
<Frame background="subtle">
  ![Image of feature flag with a disabled environment](/assets/python-tutorial-disabled-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Screenshot of app in browser without delete buttons for surveys](/assets/python-tutorial-surveys-without-delete.png)
</Frame>

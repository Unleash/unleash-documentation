...
description: In our Python feature flag tutorial, we implemented a simple feature flag that could be turned on and off. In the real world, many feature flag use cases h
keywords: python, feature, flag, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "Python Feature Flag Examples"
max-toc-depth: 3
---
...
We built multiple features into Unleash, an open-source feature flag platform, to address the complexities of releasing code and managing feature flags along the way.
...
Learn more about [gradual rollouts in our docs](/concepts/activation-strategies). Also, learn more about our API for creating a new strategy:
...
Check out our API docs on updating flag strategies:
...
<Frame background="subtle">
  ![Two variants can be configured in Unleash and saved to your strategy.](/assets/python-ex-strategy-variants-form.png)
</Frame>
...
<Frame background="subtle">
  ![View the 2 feature variants we created in a 50/50 split between your users in the development environment.](/assets/python-ex-variants-in-strategy.png)
</Frame>
...
<Frame background="subtle">
  ![From your flag page in Unleash, you go to Settings and edit the settings for your flag called 'feature information'.](/assets/python-ex-flag-settings.png)
</Frame>
...
<Frame background="subtle">
  ![There is a flag that turns on the impression data events in your flag form.](/assets/python-ex-enable-impression-data.png)
</Frame>
...
<Frame background="subtle">
  ![Event Log in Unleash tracks every single change made to flags, similar to Git commit history.](/assets/python-ex-logs.png)
</Frame>
...
Read our documentation on [Event Log](/concepts/events#event-log) and APIs to learn more:

<EndpointRequestSnippet endpoint="GET /api/admin/events" />

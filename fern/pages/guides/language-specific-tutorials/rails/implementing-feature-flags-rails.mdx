...
description: "Implement feature flags in Rails with Unleash: run locally, create a flag, add the Ruby SDK, and toggle blog post limits."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Rails"
max-toc-depth: 3
...
<Frame background="subtle">
  ![architecture diagram for our implementation](/assets/rails-guide-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![A feature flag called `top-3` is now visible.](/assets/rails-guide-enable-ff.png)
</Frame>
...
<Frame background="subtle">
  ![A blog app with a list of posts](/assets/rails-guide-blog-app.png)
</Frame>

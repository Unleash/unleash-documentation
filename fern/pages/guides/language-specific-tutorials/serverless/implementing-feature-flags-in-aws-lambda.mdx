...
description: "Implement feature flags in AWS Lambda with Unleash: initialize the Node.js SDK, cache flags, flush metrics, and scale with Edge."
keywords: serverless, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "Serverless feature flags: How to"
max-toc-depth: 3
...
<Frame background="subtle">
  ![AWS Lambda connecting to Unleash](/assets/lambda-architecture.png)
</Frame>
...
export const handler = async (event, context) => {
    ...
    return {
        statusCode: 200,
        body: { message: "Unleash SDK initialized" },
    };
};
```

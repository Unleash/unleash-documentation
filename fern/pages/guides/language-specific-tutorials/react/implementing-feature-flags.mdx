...
description: "Implement feature flags in React with Unleash: run locally, create a flag, add the SDK, and toggle UI features safely."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in React"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Cypress Real World App](/assets/react-tutorial-rwa.png)
</Frame>
...
<iframe src="https://www.youtube-nocookie.com/embed/-VzI0wqLDuw?si=cxLojllkIrZD8sf5" width="100%" height="450px" frameBorder="0" allowFullScreen></iframe>
...
<Frame background="subtle">
  ![React Feature Flag Architecture Diagram](/assets/react-tutorial-architecture-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![Keep configurations and PII secure image](/assets/react-tutorial-pii-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![Create a new feature flag](/assets/react-tutorial-create-new-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Create feature flag form](/assets/react-tutorial-create-flag-form.png)
</Frame>

Your new feature flag is created and ready to be used. Enable the flag for your development environment, which makes it accessible to be used in the React app we will generate from your local environment.

<Frame background="subtle">
  ![Enable flag for development environment](/assets/react-tutorial-enable-dev-env.png)
</Frame>
...
<Frame background="subtle">
  ![Create new API token](/assets/react-tutorial-create-api-token.png)
</Frame>
...
<Frame background="subtle">
  ![Create new projet API token](/assets/react-tutorial-create-api-token-form.png)
</Frame>
...
<Frame background="subtle">
  ![Unleash turn on feature flag](/assets/react-tutorial-disabled-flag.png)
</Frame>

Enabling the flag will result in being able to see the notifications icon in the top menu of the app.

<Frame background="subtle">
  ![Notification icon badge visible](/assets/react-tutorial-rwa-feature-on.png)
</Frame>

If you disable the flag, this results in a view of a navigation menu without the notification badge for **all** users.

<Frame background="subtle">
  ![Notification icon badge not visible](/assets/react-tutorial-rwa-feature-off.png)
</Frame>

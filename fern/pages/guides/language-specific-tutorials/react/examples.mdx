...
description: In our React tutorial, we implemented a simple on/off feature flag. In the real world, many feature flag use cases have more nuance than this. This document
keywords: react, feature, flag, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "React Feature Flag Examples"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Your strategy has a constraint saved to it.](/assets/react-ex-rollout-with-constraint.png)
</Frame>
...
<Frame background="subtle">
  ![We point to the button in Unleash to add a variant, labeled "add variant".](/assets/react-ex-add-variant.png)
</Frame>
...
<Frame background="subtle">
  ![The form allows you to configure your variant.](/assets/react-ex-variant-form.png)
</Frame>
...
<Frame background="subtle">
  ![Your feature flag view shows that a variant has been added.](/assets/react-ex-variant-added.png)
</Frame>
...
<Frame background="subtle">
  ![We can compare two variations of an icon in the app browser.](/assets/react-ex-compare-icons.png)
</Frame>
...
<Frame background="subtle">
  ![Editing feature flag settings in Unleash.](/assets/react-ex-edit-settings.png)
</Frame>

In the Settings view, click on the edit button. This will take us to the ‘Edit feature flag' form.

<Frame background="subtle">
  ![Enabling impression data for a feature flag.](/assets/react-ex-enable-impression-data.png)
</Frame>
...
<Frame background="subtle">
  ![Feature flag events showing that the flag's variants have been updated.](/assets/react-ex-event-log.png)
</Frame>

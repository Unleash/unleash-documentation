...
description: "Implement feature flags in Go with Unleash: run locally, create a flag, add the Go SDK, and toggle REST or GraphQL APIs."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Go"
max-toc-depth: 3
...
<Frame background="subtle">
  ![architecture diagram for our implementation](/assets/golang-guide-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![A gradual rollout form can allow you to customize your flag strategy.](/assets/go-example-rollout.png)
</Frame>
...
<Frame background="subtle">
  ![A feature flag called `graphql-api` is now enabled in development.](/assets/go-enable-development.png)
</Frame>

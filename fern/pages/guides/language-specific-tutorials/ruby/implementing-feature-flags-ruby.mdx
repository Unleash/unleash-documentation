...
description: "Implement feature flags in Ruby with Unleash: run locally, create a flag, add the Ruby SDK, and toggle REST or GraphQL APIs."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Ruby"
max-toc-depth: 3
---
...
<iframe src="https://www.youtube-nocookie.com/embed/lgR9jUek94U?si=nEX9vnAehlSMpkzw" width="100%" height="450px" frameBorder="0" allowFullScreen></iframe>
...
<Frame background="subtle">
  ![architecture diagram for our implementation](/assets/ruby-guide-diagram.png)
</Frame>

...
description: "Implement feature flags in Java Spring Boot with Unleash: run locally, create API tokens, add the SDK, and toggle Spring Beans."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Java Spring Boot"
max-toc-depth: 3
---
...
<iframe src="https://www.youtube-nocookie.com/embed/01LUooiDTXQ?si=z7hAgGIm642Hw6MQ" width="100%" height="450px" frameBorder="0" allowFullScreen></iframe>
...
<Frame background="subtle">
  ![Java Spring Boot Architectural Diagram](/assets/spring-boot-tutorial-architectural-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![This is an image of the Unleash platform to create a new Spring Boot feature flag.](/assets/tutorial-create-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Create a flag in Unleash called "productsPageFlag".](/assets/spring-boot-tutorial-create-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Enable the flag in the development environment in Unleash.](/assets/spring-boot-tutorial-enable-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Create a new API token in the API Access view for your Spring Boot application.](/assets/tutorial-create-api-token.png)
</Frame>
...
<Frame background="subtle">
  ![Name your API token and ensure it is a backend SDK token.](/assets/spring-boot-tutorial-create-api-token.png)
</Frame>
...
<Frame background="subtle">
  ![You can view the fully functioning app in the browser.](/assets/spring-boot-tutorial-app-in-browser.png)
</Frame>
...
<Frame background="subtle">
  ![When the flag is on, the pet prescription implementation is shown in the app browser.](/assets/spring-boot-tutorial-flag-on-in-app.png)
</Frame>
...
<Frame background="subtle">
  ![In Unleash, you can turn off the flag in the development environment.](/assets/spring-boot-tutorial-turn-flag-off.png)
</Frame>
...
<Frame background="subtle">
  ![The browser now shows that the product service is targeted.](/assets/spring-boot-tutorial-flag-off-in-app.png)
</Frame>

...
description: In our Java Spring Boot feature flag tutorial, we implemented a simple feature flag that could be turned on and off. In the real world, many feature f
keywords: java, spring, boot, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "Java Spring Boot Feature Flag Examples"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Two variants can be configured in Unleash and saved to your strategy.](/assets/spring-boot-ex-variants-form.png)
</Frame>

Your Variant tab now has the new variants we just created with their respective metadata.

<Frame background="subtle">
  ![Add a variant to your gradual rollout strategy.](/assets/spring-boot-ex-variants.png)
</Frame>
...
<Frame background="subtle">
  ![From your flag page in Unleash, you go to Settings and edit the settings for your flag called 'feature information'.](/assets/spring-boot-ex-edit-flag.png)
</Frame>

In the Settings view, click on the edit button. This will take us to the ‘Edit Feature flag’ form.

<Frame background="subtle">
  ![Enable impression data by turning switching it on in the form.](/assets/spring-boot-ex-enable-impression-data.png)
</Frame>
...
<Frame background="subtle">
  ![A Metrics graph provides the visualization of your flag being exposed in your environments for your connected application.](/assets/spring-boot-ex-metrics.png)
</Frame>
...
<Frame background="subtle">
  ![Event Log in Unleash tracks every single change made to flags, similar to Git commit history.](/assets/spring-boot-events-log.png)
</Frame>

You can also retrieve events by using an API command. Read our documentation on [Event Log](/concepts/events#event-log) and

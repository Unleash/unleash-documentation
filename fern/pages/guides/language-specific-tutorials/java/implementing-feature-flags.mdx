...
description: "Implement feature flags in Java with Unleash: run locally, create a flag, add the Java SDK, and log flag status."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in Java"
max-toc-depth: 3
...
<iframe src="https://www.youtube-nocookie.com/embed/Hq1g9QyPw14?si=azduTa_lQsDBmOdm" width="100%" height="450px" frameBorder="0" allowFullScreen></iframe>
...
<Frame background="subtle">
  ![An architectural diagram shows how the Java SDK, application and unleash server control feature experiences.](/assets/java-tutorial-architecture-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![This is an image of the Unleash platform to create a new Java feature flag.](/assets/tutorial-create-flag.png)
</Frame>
...
<Frame background="subtle">
  ![You can view the Java feature flag form in Unleash.](/assets/java-tutorial-flag-form.png)
</Frame>
...
<Frame background="subtle">
  ![Enable your new flag in the development environment in your flag view.](/assets/java-tutorial-enable-flag.png)
</Frame>
...
<Frame background="subtle">
  ![Create a new API token in the API Access view for your Java application.](/assets/tutorial-create-api-token.png)
</Frame>
...
<Frame background="subtle">
  ![Name your API token and make sure it is a backend SDK token.](/assets/java-tutorial-api-token-form.png)
</Frame>
...
<Frame background="subtle">
  ![You can view the status of your flag in the Terminal from our log statements, which should read "STATUS: endpoint flag is enabled".](/assets/java-tutorial-status-log.png)
</Frame>
...
<Frame background="subtle">
  ![Turn off the flag in the development environment.](/assets/java-tutorial-disable-flag.png)
</Frame>
...
<Frame background="subtle">
  ![The status of the feature flag will now change from "enabled" to "disabled" in your Terminal.](/assets/java-tutorial-status-log-change.png)
</Frame>

...
description: "Implement feature flags in .NET with Unleash: run locally, create a flag, add the .NET SDK, and toggle REST or GraphQL APIs."
keywords: implement, feature, flags, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "How to Implement Feature Flags in .NET"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![architecture diagram for our implementation](/assets/dotnet-guide-diagram.png)
</Frame>
...
<Frame background="subtle">
  ![Create a new feature flag](/assets/ruby-guide-new-ff.png)
</Frame>

Call it `graphql-api` and enable it in the `development` environment.

<Frame background="subtle">
  ![A feature flag called `graphql-api` is now visible.](/assets/ruby-guide-enable-ff.png)
</Frame>
...
<Frame background="subtle">
  ![Image of the API token list](/assets/tutorial-api-token-list.png)
</Frame>
...
<Frame background="subtle">
  ![A feature flag called `graphql-api` is now disabled](/assets/ruby-guide-graphql-ff.png)
</Frame>

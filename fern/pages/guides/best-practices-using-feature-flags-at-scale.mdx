...
keywords: feature, flag, management, feature flags, unleash
...
<Frame background="subtle">
  ![Evaluate flags at the edge](/assets/evaluate-flags-at-the-edge.jpg)
</Frame>
...
<Frame background="subtle">
  ![Evaluate flags once](/assets/evaluate-flags-in-many-places.jpg)
</Frame>
...
<Frame background="subtle">
  ![Evaluate flags once](/assets/evaluate-flags-only-once.jpg)
</Frame>

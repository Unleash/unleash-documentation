...
- **Every non-trivial change is reversible.** If you can't disable it instantly, reconsider enabling it. This is the practical application of [runtime control](#1-enable-runtime-control) and [kill switches](#2-make-flags-short-lived).

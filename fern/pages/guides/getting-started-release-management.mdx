...
og:title: Get Started with Release Management - Unleash Documentation
description: Learn how to use Unleash's release management features to automate and safeguard your feature rollouts with release templates, impact metrics, automated progressions and safeguards.
keywords: release management, getting started, release templates, impact metrics, safeguards, automated rollouts, feature flags, tutorial
max-toc-depth: 3
...
You can define a metric in your application code using the Unleash SDK, or [create it directly in the Admin UI](/concepts/impact-metrics#create-a-metric-from-the-ui). Either way, your application records the metric values through the SDK.

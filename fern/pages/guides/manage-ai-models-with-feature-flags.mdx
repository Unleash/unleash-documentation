...
description: "Manage AI models with Unleash feature flags: switch LLM configs, test variants, roll out updates, and avoid redeploys."
keywords: experiment, with, using, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "Experiment with AI using feature flags"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![chatbot UI](/assets/sveltekit-chatbot.png)
</Frame>
...
<Frame background="subtle">
  ![a variant with parameters for an OpenAI model](/assets/model-variant.png)
</Frame>

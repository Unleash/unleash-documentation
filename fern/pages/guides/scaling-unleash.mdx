...
description: Scale Unleash for enterprise workloads with high availability, local flag evaluation, caching, Edge, monitoring, and self-hosting tips.
keywords: scaling, unleash, enterprise, feature flags, implementation
og:site_name: "Unleash Documentation"
og:title: "Scaling Unleash for enterprise workloads"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Architecture using Enterprise Edge](/assets/architecture-enterprise-edge.png)
</Frame>
...
<Frame background="subtle">
  ![How we scale Unleash](/assets/scaling-unleash-unleash.jpg)
</Frame>
...
<Frame background="subtle">
  ![How we scale Unleash Edge](/assets/scaling-unleash-edge.jpg)
</Frame>

...
description: "Secure feature flags at scale with Unleash: configure SSO, SCIM, RBAC, change requests, and audit logs."
keywords: implement, user, management, feature flags, unleash
og:site_name: "Unleash Documentation"
og:title: "Implement user management, access controls, and auditing with feature flags"
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![In Unleash's Single Sign-On page, there are four tabs to set up Open ID Connect, SAML 2.0, traditional passwords, and SCIM.](/assets/use-case-user-mgmt-saml.png)
</Frame>
...
<Frame background="subtle">
  ![The password tab has a toggle that you can turn off.](/assets/use-case-user-mgmt-disable-password-login.png)
</Frame>
...
<Frame background="subtle">
  ![Turn the **SCIM provisioning** toggle on to enable SCIM.](/assets/use-case-user-mgmt-scim-protocol.png)
</Frame>
...
<Frame background="subtle">
  ![Manage all user roles in the Unleash Admin UI.](/assets/use-case-user-mgmt-root-roles.png)
</Frame>
...
<Frame background="subtle">
  ![In the "New root role" form, name your role, add a description, and select permissions in each dropdown section in the form.](/assets/use-case-user-mgmt-custom-role.png)
</Frame>
...
<Frame background="subtle">
  ![You can view the list of change requests with their relevant metadata.](/assets/use-case-user-mgmt-change-requests.png)
</Frame>
...
<Frame background="subtle">
  ![This GIF shows how to quickly make changes to your feature flag, request the change, approve it, and apply the changes.](/assets/use-case-user-mgmt-cr.gif)
</Frame>
...
<Frame background="subtle">
  ![This event log captures a change request cancellation, the user who performed the cancellation, and other metadata.](/assets/use-case-user-mgmt-event-log.png)
</Frame>

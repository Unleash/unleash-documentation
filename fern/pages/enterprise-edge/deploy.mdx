...
description: Deploy Enterprise Edge self-hosted on your infrastructure with full control over networking, data persistence, and geographic regions.
keywords: enterprise edge, deploy, self-hosted, docker, kubernetes, helm, persistence, redis, s3
og:site_name: Unleash
og:title: Deploy Enterprise Edge
max-toc-depth: 2
---

<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v7.3</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v19.10</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v19</Button> <Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v5.9</Button>

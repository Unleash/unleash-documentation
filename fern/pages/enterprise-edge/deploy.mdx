...
<Button small outlined className="version-button" href="/support/availability">Edge v19.10</Button>
...
<Button small outlined className="version-button" href="/support/availability">Edge v19</Button> <Button small outlined className="version-button" href="/support/availability">v5.9</Button>

...
<Button small outlined className="version-button" href="/support/availability">v8</Button> <Button small outlined className="version-button" href="/support/availability">Edge v20.2.2</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>

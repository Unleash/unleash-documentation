...
og:title: Microsoft Teams
description: "Set up the Unleash Microsoft Teams integration to post feature flag updates, configure events, webhooks, channels, and retries."
max-toc-depth: 2
slug: integrate/teams

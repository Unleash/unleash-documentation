...
og:title: Jira Server Integration - Installation
max-toc-depth: 2
slug: integrate/jira-server-plugin-installation
---
...
<Frame>
![The Jira "manage apps" page. The "upload app" button is visually highlighted.](/assets/jira_upload_app.png)
</Frame>
...
<Frame>
![The successful install screen mentioned in the preceding paragraph.](/assets/jira_server_installed_ready_to_go.png)
</Frame>
...
<Frame>
![The "configure servers" link highlighted in the Manage Apps menu.](/assets/jira_server_manage_unleash_admin.png)
</Frame>
...
<Frame>
![A table marked Unleash Server Configuration, listing Unleash server instances.](/assets/jira_server_manage_servers.png)
</Frame>
...
<Frame>
![An "editing server" form. The fields are "JIRA project", "Name", "Api URL", "Api Key"](/assets/jira_server_edit_server.png)
</Frame>
...
<Frame>
![A plugin deletion confirmation dialog. It gives you two options: "Delete connection", and "Cancel".](/assets/jira_server_delete_server_confirmation.png)
</Frame>
...
<Frame>
![A warning dialog telling you that you can't delete a server.](/assets/jira_server_delete_connected_toggles.png)
</Frame>

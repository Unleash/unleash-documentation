...
og:title: Jira Cloud Integration - Installation
description: "Install the Unleash Jira Cloud plugin to link feature flags with Jira issues, select environments, and assign projects."
max-toc-depth: 2
slug: integrate/jira-cloud-plugin-installation
---
...
<Frame>
![Atlassian marketplace landing page for the Unleash Enterprise For Jira plugin.](/assets/unleash-marketplace-for-unleash-enterprise-jira-plugin.png)
</Frame>
...
<Frame>
![Jira Cloud project settings page with the apps menu open. The link to Unleash project settings is highlighted.](/assets/jira-cloud-project-settings-link.png)
</Frame>
...
<Frame>
![Jira Cloud: Unleash project settings. A form with inputs for Unleash URL and an Unleash auth token.](/assets/jira-cloud-project-settings.png)
</Frame>

...
<Note>
If new changes are added to an Unleash change request that was already approved, the corresponding ServiceNow change is cancelled and a new one is created.
</Note>

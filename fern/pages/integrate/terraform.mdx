...
og:title: Using Unleash through Terraform
description: "Manage Unleash with Terraform: automate projects, environments, API tokens, users, roles, SSO, and context fields."
keywords: terraform, infrastructure as code, iac, api tokens, environments, projects, service accounts, sso configuration
max-toc-depth: 3
slug: integrate/terraform
last-updated: August 25, 2026
---

<Button small outlined className="version-button" href="/support/availability">v5.6</Button>
...
- For [Open Source](https://www.getunleash.io/pricing), use [personal access tokens](/concepts/api-tokens-and-client-keys#personal-access-tokens).

...
og:title: App for Slack
description: "Set up the Unleash App for Slack to send feature flag updates, change requests, and project events to selected channels."
max-toc-depth: 2
slug: integrate/slack-app
---
...
<Frame>
![Example of Slack-specific tags](/assets/slack-addon-tags.png)
</Frame>

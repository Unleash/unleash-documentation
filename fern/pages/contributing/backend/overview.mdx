---
title: Back end
description: Comprehensive guide to Unleash's backend development, including setup, PostgreSQL configuration, database migrations, and architectural decision records.
keywords: [backend, Node.js, TypeScript, PostgreSQL, REST API, CSR pattern, database migrations, development setup]
og:title: Back end

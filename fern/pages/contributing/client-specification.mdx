...
description: A comprehensive guide for implementing an Unleash Client SDK, covering system overview, basic API, activation strategies, polling, and metrics.
keywords: [client specification, SDK, implementation guide, activation strategies, feature flags, isEnabled, metrics, polling]
og:title: Client Specification
...
![system_overview](/assets/unleash-diagram.png)
</Frame>

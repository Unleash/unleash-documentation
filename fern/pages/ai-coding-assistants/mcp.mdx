...
<Warning>
Only enable the remote MCP server if your organization allows the OAuth 2.0 Dynamic Client Registration authorization workflow. Enabling it allows MCP clients to self-register with your instance. See [Authentication](#authentication) for details.
</Warning>

...
- On [GitHub.com](https://github.com/features/copilot), a web-based Copilot (no MCP support).
...
Try one of the following prompts (or the [prompt patterns](#prompt-patterns) below):

...
keywords: sdk, client, library, backend, frontend, mobile, feature flags, evaluation
...
| [Regex operator](/concepts/activation-strategies#regex-operator) | ✅ (12.2.0) | ✅ (6.10.0) | ✅ (6.2.0) | ✅ (6.6.0) | ✅ (6.5.0) | ✅ (6.1.0) | ❌ | ✅ (0.16.0) |
| [IP address operator](/concepts/activation-strategies#ip-address-operator) (`IN_CIDR`) | ✅ (12.3.0) | ✅ (6.11.0) | ✅ (6.4.0) | ✅ (6.7.0) | ✅ (6.7.1) | ✅ (6.2.0) | ❌ | ✅ (0.16.0) |
...
| Capability | [Java](/sdks/java) | [Node.js](/sdks/node) | [Go](/sdks/go) | [Python](/sdks/python) | [Ruby](/sdks/ruby) | [.NET](/sdks/dotnet) | [PHP](/sdks/php) | [Rust](/sdks/rust) |
| --- | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
| [Strategy variants](/concepts/strategy-variants) and [custom stickiness](/concepts/stickiness#custom-stickiness) | ✅ (8.3.0) | ✅ (4.1.0) | ✅ (3.8.0) | ✅ (5.8.0) | ✅ (4.5.0) | ✅ (3.3.0) | ✅ (1.13.0) | ✅ (0.16.0) |

Versions in parentheses are the minimum SDK versions that support [strategy variants](/concepts/strategy-variants#client-sdk-support).
...
#### Frontend SDKs
| Interval | [Android](/sdks/android) | [Flutter](/sdks/flutter) | [iOS](/sdks/ios) | [JavaScript](/sdks/javascript-browser) | [Next.js](/sdks/next-js) | [React](/sdks/react) | [React Native](/sdks/react-native) | [Svelte](/sdks/svelte) | [Vue](/sdks/vue) |
| --- | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: | :-: |
...
Unleash also supports [OpenFeature](https://openfeature.dev/), an open standard that provides a vendor-neutral API for feature flagging. In OpenFeature, a provider is the component that connects the OpenFeature SDK to a flag management system. The Unleash providers translate OpenFeature API calls into Unleash SDK operations: Unleash still manages and evaluates your flags, while your application code depends only on the OpenFeature API.

OpenFeature can be useful when you want a common feature flag interface across services, frameworks, or vendors. The trade-off is that the OpenFeature API models only the capabilities that feature flag systems have in common. It does not cover Unleash-specific capabilities, such as [impression data](/concepts/impression-data) and [impact metrics](/concepts/impact-metrics), including the [safeguards](/concepts/impact-metrics#configure-safeguards) that depend on them. To get the most out of Unleash, we recommend that you use the Unleash SDKs directly.

Unleash maintains the following OpenFeature providers:

-   [Node.js provider](/sdks/openfeature/node)
-   [PHP provider](/sdks/openfeature/php)
-   [Python provider](https://github.com/Unleash/unleash-openfeature-python-provider)
-   [Ruby provider](/sdks/openfeature/ruby)
-   [Rust provider](https://github.com/Unleash/unleash-openfeature-rust-provider)
-   [Swift provider](https://github.com/Unleash/unleash-openfeature-swift-provider)
...
-   [Client Specification](https://github.com/Unleash/unleash/blob/main/contributing/client-specification.md) - A brief guide of the _Unleash Architecture_ and important aspects of the SDK role in it all.
...
Unless the SDK supports [bootstrapping](#bootstrap), it needs to connect to Unleash at startup to get its initial feature flag data set. If the SDK doesn't have a feature flag data set available, all flags fall back to evaluating as disabled or as the specified default value.

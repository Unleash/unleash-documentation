...
If you use [custom strategies](#custom-strategies) or override built-in ones, read the complete [migration guide](https://github.com/Unleash/unleash-ruby-sdk/blob/main/./v6_MIGRATION_GUIDE.md) before upgrading to v6.
</Note>
...
2. Update documentation:
     - If the update includes a major or minor version change, update the [Installation section](#installation) in [README.md](https://github.com/Unleash/unleash-ruby-sdk/blob/main/README.md).
     - Update [CHANGELOG.md](https://github.com/Unleash/unleash-ruby-sdk/blob/main/CHANGELOG.md) following the format on [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
3. Commit changes:

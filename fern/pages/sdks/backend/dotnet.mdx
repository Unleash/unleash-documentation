...
If you use [bootstrapping](#bootstrapping), [custom strategies](#custom-strategies), or a custom JSON serializer, read the complete [migration guide](https://github.com/Unleash/unleash-dotnet-sdk/blob/main/./v5_MIGRATION_GUIDE.md) before upgrading to v5.
</Warning>
...
- Check out our guide for more information on how to build and scale [feature flag](/guides/feature-flag-best-practices) systems

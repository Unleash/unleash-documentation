...
If you're organizing your feature toggles in projects in Unleash Enterprise, you can [scope your API tokens](/concepts/api-tokens-and-client-keys) to include only the specific projects needed for your client. Then use that token when configuring the Unleash client:
...
You can also provide an [Unleash context](/concepts/unleash-context) to the `IsEnabled` method:
...
* Example bootstrap files can be found in the json files located in [tests/Unleash.Tests/App_Data](https://github.com/Unleash/unleash-dotnet-sdk/blob/main/tests/Unleash.Tests/App_Data)

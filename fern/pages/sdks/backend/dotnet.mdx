...
You can also pass an [Unleash context](/concepts/unleash-context) to evaluate flags for a specific user, session or other properties required by constraints or custom strategies. Refer to the [Unleash context](#unleash-context) section for details.

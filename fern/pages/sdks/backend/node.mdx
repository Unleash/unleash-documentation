...
The Node.js SDK supports a bootstrap parameter, allowing you to load the initial feature flag
...
Bootstrap is a convenient way to increase resilience, where the SDK can still load fresh flag

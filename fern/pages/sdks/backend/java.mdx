...
og:title: Java SDK
description: Java SDK for integrating with Unleash feature management platform
...
- Java 11 or newer (SDK v11+)
- Java 8 is supported on SDK v10.2.x and below
...
You can also **provide an [Unleash context](/concepts/unleash-context)** to the `isEnabled` method. Refer to the [Unleash context](#unleash-context) section for more information about using the Unleash context in the Java SDK.
...
By default unleash-client fetches the feature flags from unleash-server every 10s, and stores the

...
This server-side Java SDK is designed to help you integrate with Unleash and evaluate feature flags inside your application.
...
If you're using `MoreOperations`, custom or fallback strategies, subscribers or bootstrapping, please see the full [migration guide](https://github.com/Unleash/unleash-java-sdk/blob/main/v10_MIGRATION_GUIDE.md) for details. If you use GraalVM or Quarkus, please hold off on upgrading to v10, support is planned but not implemented.
</Note>
...
<Tip>
Refer to the section on [configuration options](#configuration-options) for a more complete explanation of all the options.
</Tip>
...
Read more about the strategies in the [activation strategies reference documentation](/concepts/activation-strategies).
...
Check out our documentation for tips and best practices on [building and scaling feature flag systems](/guides/feature-flag-best-practices).

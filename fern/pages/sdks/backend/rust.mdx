...
og:title: Rust SDK
description: Set up the Unleash Rust SDK to evaluate feature flags with async clients, context, custom strategies, metrics, and Edge.
keywords: [unleash, rust, sdk, feature flags, feature toggles]
max-toc-depth: 3
---

<Markdown src="/snippets/sdks/backend-intro.mdx" language="Rust" />

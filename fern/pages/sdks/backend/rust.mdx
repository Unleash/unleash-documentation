...
og:title: Rust SDK
description: Rust SDK for integrating with Unleash feature management platform
keywords: [unleash, rust, sdk, feature flags, feature toggles]
max-toc-depth: 3
---

This Rust SDK is designed to help you integrate with Unleash and evaluate feature flags in Rust programs.

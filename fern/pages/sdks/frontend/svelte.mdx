---
title: Svelte SDK
description: Integrate feature flags in your Svelte applications using the Unleash Svelte SDK
...
- [Front-end API](/api#frontend-api)
...
To connect this SDK to the [Unleash Edge](/unleash-edge), use the URL to your Unleash Edge instance as the `url` parameter. For the `clientKey` parameter, use a `FRONTEND` token generated from your Unleash Edge instance. Refer to the [API tokens documentation](/concepts/api-tokens-and-client-keys) for more information. Ensure that your Unleash Edge instance is correctly configured to have access to the feature toggles your `FRONTEND` token is requesting.

...
Set `url` to the `/api/frontend` endpoint of your Unleash instance or your [Unleash Edge](/unleash-edge) instance. Set `clientKey` to a [frontend API token](/concepts/api-tokens-and-client-keys#front-end-tokens).
...
Add a `bootstrap` attribute when you create a new `UnleashClient`.

---
title: Next.js SDK
description: Set up the Unleash Next.js SDK to evaluate feature flags with App Router, middleware, SSR, SSG, bootstrap, and toolbar support.
...
<Note>When used server-side, this SDK does not support the "Hostname" and "IP" strategies.</Note>

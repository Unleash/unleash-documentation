...
<Note>If your current implementation relies on Unleash Proxy, please review our guide on how to [migrate to Unleash Edge](https://docs.getunleash.io/reference/unleash-edge/migration-guide).</Note>

...
- `{appName}:sessionId`: a persistent session identifier used for [gradual rollouts](/concepts/gradual-rollout), [constraints](/concepts/activation-strategies#constraints), and [stickiness](/concepts/stickiness).

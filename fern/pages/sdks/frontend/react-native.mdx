...
If you need instant startup without a loading state, use [bootstrapping](#bootstrapping) to provide initial flag values. The SDK uses bootstrap data immediately and updates it in the background once the network request completes.

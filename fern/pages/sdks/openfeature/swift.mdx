...
The detail methods, such as `getBooleanDetails`, additionally report the assigned variant name. The evaluation reason is always `UNKNOWN` because Unleash frontend SDKs don't report why a flag evaluated the way it did.

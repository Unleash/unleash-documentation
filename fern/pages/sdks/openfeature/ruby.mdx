...
Create an `Unleash::OpenFeature::Provider::UnleashFlagProvider` with the same [options](/sdks/ruby#configuration) you would pass to the Unleash Ruby SDK client, then register that provider with OpenFeature.

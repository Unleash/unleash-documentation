...
The [Unleash OpenFeature Ruby provider](https://github.com/Unleash/unleash-openfeature-ruby-provider) lets Ruby applications evaluate Unleash feature flags through the [OpenFeature](https://openfeature.dev/) API.

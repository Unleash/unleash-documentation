...
For self-hosted deployments, cryptographic protection is managed at the infrastructure layer. TLS termination and encryption happen at the level of infrastructure components such as load balancers, reverse proxies, and database connections rather than implementing custom cryptographic primitives. Customers achieve FIPS compliance by:

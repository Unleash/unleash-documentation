...
Internal impact metrics data is retained for **6 months**. Data older than 6 months is automatically deleted. External metrics are not stored in Unleash, so this limit does not apply to them.

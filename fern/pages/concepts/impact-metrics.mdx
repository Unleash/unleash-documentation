...
- **Disable environment**: Turns the flag off in this environment. Existing users stop seeing the flag immediately. Use this action as a kill switch for flags that should be paused entirely when health degrades.

...
The URL must be reachable from the Unleash server over the network. Each request to the backend has a 20-second timeout. Internal metrics continue to work in parallel and remain the default source.

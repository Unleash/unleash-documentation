...
Lookaheads and backreferences are not supported. If the context field is missing, the constraint evaluates to false.

<Accordion title="SDK requirements">

The regex operator requires the following SDK versions or later. Frontend SDKs support it when connected to Unleash or Unleash Enterprise Edge.
...
| Rust                    | 0.16.0          |
| PHP                     | Not supported   |
| Unleash Enterprise Edge | 20.1.9          |
...
The IP address operator requires the following SDK versions or later. Frontend SDKs support it when connected to Unleash or Unleash Enterprise Edge.
...
| Rust                    | 0.16.0          |
| PHP                     | Not supported   |
| Unleash Enterprise Edge | 20.2.0          |

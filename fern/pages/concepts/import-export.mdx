...
og:title: Import and export - Migrate feature flag configurations between environments
description: You can import and export feature flag configurations between environments within an instance or between different Unleash instances. This lets you migrate between self-hosted and cloud-hosted instances.
keywords: import, export, migration, feature flags, environments
max-toc-depth: 3
---

<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.22</Button>
...
![Export all flags from a project](/assets/export-all-project-flags.png)
</Frame>
...
<Frame background="subtle">
![Export a selection of flags from a project.](/assets/export-flag-selection.png)
</Frame>
...
<Frame background="subtle">
![Export flags from the flags overview](/assets/export-flags-overview.png)
</Frame>
...
<Frame background="subtle">
![The import UI. It has three stages: import file, validate configuration, finish import.](/assets/import-steps.png)
</Frame>
...
<Frame background="subtle">
![The import UI. It has three stages: import file, validate configuration, finish import.](/assets/import.png)
</Frame>

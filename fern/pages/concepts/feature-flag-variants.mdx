...
og:title: Feature flag variants (deprecated) - Use strategy variants instead
description: Feature Flag Variants at the environment level are deprecated in favor of strategy variants. Only features that have existing feature environment variants will keep them.
keywords: variants, deprecated, strategy variants, a/b testing, experimentation
max-toc-depth: 3
---
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v3.2</Button>
...
![A form for adding new variants. It has fields for name, weight, payload, and overrides.](/assets/variant-creation-form.png)
</Frame>
...
<Frame background="subtle">
![flag_variants](/assets/variants.png)
</Frame>

...
og:title: Search - Filter and find feature flags with advanced operators
description: Search with filters and operators allows users to conduct flexible data filtering. This feature is available on the Global Features Page and the Project Page.
keywords: search, filters, operators, feature flags, segments, tags
max-toc-depth: 3
---

<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v5.9</Button>
...
<EndpointRequestSnippet endpoint="GET /api/admin/features" />

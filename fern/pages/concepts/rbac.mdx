...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.0</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v5.4</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v6.9</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v6.8 in BETA</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.6</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v5.6</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v6.9</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.14</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.18</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>

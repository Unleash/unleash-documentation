...
Permisssions to manage [API tokens](/concepts/api-tokens-and-client-keys).
...
Permisssions to manage [applications](/concepts/applications).
...
Permisssions to manage authentication settings.
...
Permisssions to manage [context fields](/concepts/unleash-context#custom-context-fields).
...
Permisssions to manage instance-wide maintenance settings.
...
Permisssions to manage [integrations](/integrate).
...
Permisssions to manage [projects](/concepts/projects).
...
<Button small outlined className="version-button" href="/support/availability">v6.8 in BETA</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>

Permisssions to manage [release templates](/concepts/release-templates).
...
Permisssions to manage [roles](/concepts/rbac).
...
Permisssions to manage [strategies](/concepts/activation-strategies).
...
Permisssions to manage [tag types](/concepts/feature-flags#tags).

...
og:title: Custom activation strategies - Define your own activation strategies
description: Custom activation strategies let you define your own activation strategies to use with Unleash. When the built-in activation strategies aren't enough, custom activation strategies provide the flexibility you need.
keywords: custom strategies, activation strategies, gradual rollout, constraints
max-toc-depth: 3
last-updated: August 25, 2026
---

<Note>
Whenever possible, we recommend using a standard [gradual rollout](/concepts/activation-strategies#gradual-rollout) strategy with [strategy constraints](/concepts/activation-strategies#constraints) instead of defining a custom strategy. They offer similar flexibility without requiring custom code distribution within your SDKs, which becomes a maintenance burden as your SDKs and strategies evolve.
If you have a use case you can't solve without custom strategies, please reach out to us.
</Note>

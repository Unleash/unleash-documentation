...
description: Variants let you expose different versions of a feature to users for A/B and multivariate testing, configured within activation strategies.
keywords: strategy variants, variants, ab testing, multivariate testing, variant weight, payload, stickiness, activation strategies
og:site_name: Unleash Documentation
og:title: Strategy Variants for A/B and Multivariate Testing
max-toc-depth: 3
last-updated: August 10, 2026
---

<Button small outlined className="version-button" href="/support/availability">v5.4</Button>
...
<div class="hero-video">
    <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/M0oyGHtva0o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
<Frame background="subtle">
  ![Adding new strategy variants](/assets/strategy-variant-creation-form.png)
</Frame>
...
6. Toggle **Custom percentage** for [fixed weights](#weight-type), if required.
...
<Frame background="subtle">
  ![strategy_variants example](/assets/strategy-variants-example.png)
</Frame>

## Client SDK support

Strategy variants require Unleash 5.4 or later and the following minimum backend SDK versions:

| SDK | Minimum version |
|-----|-----------------|
| [Java](/sdks/java) | 8.3.0 |
| [Node.js](/sdks/node) | 4.1.0 |
| [Go](/sdks/go) | 3.8.0 |
| [Python](/sdks/python) | 5.8.0 |
| [Ruby](/sdks/ruby) | 4.5.0 |
| [.NET](/sdks/dotnet) | 3.3.0 |
| [PHP](/sdks/php) | 1.13.0 |
| [Rust](/sdks/rust) | 0.16.0 |

Backend SDKs evaluate strategy variants locally. If an SDK version predates strategy variant support, it does not evaluate them and returns the [fallback variant](#fallback-variant).

Frontend SDKs receive variants that the Unleash server, [Unleash Edge](/unleash-edge), or the [Frontend API](/concepts/front-end-api) has already evaluated, so they work with strategy variants without evaluating them locally.

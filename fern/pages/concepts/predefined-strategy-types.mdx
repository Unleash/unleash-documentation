...
description: Predefined strategy types are a legacy implementation. Use the default strategy with strategy constraints to achieve your desired targeting.
keywords: predefined strategies, legacy, gradual rollout, user id, session id, deprecated
max-toc-depth: 3
---

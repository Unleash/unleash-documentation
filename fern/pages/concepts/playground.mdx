...
og:title: Playground - Test feature flag evaluation with different contexts
description: The Unleash playground is part of the Admin UI that lets you see which feature flags would be enabled for a given Unleash context. It helps debug and understand flag evaluation.
keywords: playground, testing, debugging, evaluation, context, strategies
max-toc-depth: 3
---

<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.14</Button>


<Frame background="subtle">
![The Unleash Playground form and an indication of where in the nav menu it is located.](/assets/playground-form.png)
</Frame>
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v5.3</Button>
...
<Frame background="subtle">
![Playground results: a table of feature names and whether they're enabled or not.](/assets/playground-results.png)
</Frame>
...
<Frame background="subtle">
![Playground results](/assets/playground-results-row.png)
</Frame>
...
<Frame background="subtle">
![Playground results in development](/assets/playground-results-development.png)
</Frame>
...
<Frame background="subtle">
![The diff view in playground](/assets/playground-results-diff.png)
</Frame>


### Detailed evaluation results

<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.15</Button>

<Frame background="subtle">
![Detailed strategy evaluation results. A list of strategies and their constraints along with indicators of whether each one is `true` or `false`.](/assets/playground-detailed-results.png)
</Frame>

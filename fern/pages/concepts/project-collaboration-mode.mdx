...
og:title: Project collaboration mode - Manage project visibility and access control
description: Project collaboration modes allow you to manage project visibility and interaction levels, ensuring better control and collaboration within your organization.
keywords: collaboration mode, project visibility, access control, permissions, private projects
max-toc-depth: 3
---

<Button small outlined className="version-button" href="/support/availability">v4.22</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
| Private   | Project Members, Admins, Editors, and users with any [custom root role](/concepts/rbac#custom-root-roles) | Project Members and Admins |

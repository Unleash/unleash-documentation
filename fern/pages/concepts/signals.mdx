---
title: Signals
description: Signals represent events from external systems that can trigger automated actions in Unleash through a simple HTTP API.
keywords: signals, signal endpoints, external events, actions, integrations, api, webhooks
og:site_name: Unleash Documentation
og:title: Signals for External Event Integration
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Signals from external systems.](/assets/signals-input.png)
</Frame>
...
<Frame background="subtle">
  ![Integrations menu.](/assets/integrations.png)
</Frame>

In the integrations page, select the Signals integration:

<Frame background="subtle">
  ![Integrations menu.](/assets/signals-option.png)
</Frame>
...
<Frame background="subtle">
  ![New signal form.](/assets/new-signal-form.png)
</Frame>
...
<Frame background="subtle">
  ![View signals option.](/assets/view-signals-option.png)
</Frame>

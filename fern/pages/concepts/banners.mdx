...
og:title: Banners - Display instance-wide messages to all users
description: Banners allow you to configure and display instance-wide messages to all users of your Unleash instance. These messages appear at the top of the Unleash UI and can be configured to be interactive.
keywords: banners, notifications, announcements, messages, admin
max-toc-depth: 3
---
...
![Banners table](/assets/banners-table.png)
</Frame>

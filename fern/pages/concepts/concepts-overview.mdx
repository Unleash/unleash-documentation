...
og:title: Core concepts - Understanding how Unleash works
description: This guide provides a conceptual overview of how Unleash works, covering the various components that exist within the system and how they interact with each other and with external applications.
keywords: concepts, projects, environments, feature flags, activation strategies, constraints
max-toc-depth: 3
---
...
[Enterprise](https://www.getunleash.io/pricing) customers can create, rename, and delete projects. [Open Source](https://www.getunleash.io/pricing) users have a single project called 'Default'.

<Frame background="subtle">
![Unleash projects contain one or more environments](/assets/anatomy-of-unleash-environment.png)
</Frame>

## Environments and project environments

<Frame background="subtle">
![Activating feature flags in environments](/assets/anatomy-of-unleash-customer-tiers.png)
</Frame>
...
[Enterprise](https://www.getunleash.io/pricing) users can create and remove environments. [Open Source](https://www.getunleash.io/pricing) customers get access to two environments: **development** and **production.**
...
<Frame background="subtle">
![Constraints and activation strategies](/assets/anatomy-of-unleash-environments.png)
</Frame>
...
<Frame background="subtle">
![A project containing an environment containing a feature flag configuration](/assets/anatomy-of-unleash-features.png)
</Frame>
...
<Frame background="subtle">
![An environment containing a feature flag configuration with an activation strategy](/assets/anatomy-of-unleash-strategy.png)
</Frame>
...
<Frame background="subtle">
![Feature flags across environments with different activation strategies](/assets/anatomy-of-unleash-environments-strategies.png)
</Frame>

<Frame background="subtle">
![Copying activation strategies](/assets/anatomy-of-unleash-environments-strategies2.png)
</Frame>
...
<Frame background="subtle">
![Example of constraints applied to strategies](/assets/anatomy-of-unleash-constraint.png)
</Frame>
...
<Frame background="subtle">
![An example of segments](/assets/anatomy-of-unleash-segments.png)
</Frame>
...
<Frame background="subtle">
![Illustration showing showing a release template is made up of milestones](/assets/anatomy-of-unleash-release-template.png)
</Frame>
...
<Frame background="subtle">
![Illustration showing showing that a release template can be applied to a feature flag](/assets/anatomy-of-unleash-release-template-apply.png)
</Frame>
...
<Frame background="subtle">
![Illustration showing showing a release template applied to a feature flag in an environment](/assets/anatomy-of-unleash-release-template-applied.png)
</Frame>
...
<Frame background="subtle">
![Variants after version 4.21](/assets/anatomy-of-unleash-variants-environment.png)
</Frame>

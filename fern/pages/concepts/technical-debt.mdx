...
description: Feature flag technical debt accumulates when flags are not managed or retired after their intended use, leading to increased complexity and risk.
keywords: technical debt, stale flags, potentially stale, feature flag lifecycle, project status, cleanup
og:site_name: Unleash Documentation
og:title: Managing Feature Flag Technical Debt
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![Mark a flag as stale in a project](/assets/stale-flag-project.png)
</Frame>
...
<Frame background="subtle">
  ![Project status dashboard](/assets/project-status.png)
</Frame>

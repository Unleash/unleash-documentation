...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|
| Release             | Manage the release of new or incomplete features.                                                                                          | 40 days           |
...
| Sunset              | Coordinate the planned removal of an existing feature.                                                                                                              | 90 days           |
...
The status message depends on the lifecycle stage. In the **Define** stage, the status shows why the flag hasn't received metrics yet. For example, **No strategies** or **No enabled strategies** indicate missing [activation strategies](/concepts/activation-strategies) or strategies that aren't enabled.
Similarly, in the **Develop** stage, the status shows whether any environment is enabled.

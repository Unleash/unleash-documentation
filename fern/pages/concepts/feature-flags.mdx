...
- In the **Define** stage, the status reflects whether non-production environments have traffic, [activation strategies](/concepts/activation-strategies), or enabled strategies.

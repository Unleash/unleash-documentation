...
og:title: Frontend API - Simplify connecting client-side applications to Unleash
description: The Unleash Frontend API simplifies connecting client-side applications to Unleash. It has a straightforward setup and is built directly into Unleash.
keywords: frontend api, client-side, cors, api tokens, refresh interval
max-toc-depth: 3
---

<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v4.18</Button>

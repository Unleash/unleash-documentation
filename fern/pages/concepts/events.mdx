...
og:title: Events - Track changes across your Unleash instance
description: Events help you keep track of changes across your Unleash instance. You can explore events in Event Log or using the global Event Timeline.
keywords: events, event log, event timeline, auditing, debugging, signals
max-toc-depth: 3
---
...
<Button small outlined className="version-button" href="https://docs.getunleash.io/support/availability">v6.3 in BETA</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
![Event timeline in Unleash Admin UI](/assets/event-timeline.png)
</Frame>

...
Rather than setting an expiration date, we recommend [rotating tokens](#rotate-a-token) on a regular schedule. This keeps token hygiene in your control without the risk of a token expiring unnoticed.

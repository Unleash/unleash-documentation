...
og:title: Network - Overview of incoming requests to your Unleash instance
description: The Network dashboards in the Unleash Admin UI give you an overview of incoming requests to your Unleash instance from SDKs, Edge, or the Admin UI.
keywords: network, traffic, data usage, prometheus, metrics, monitoring
max-toc-depth: 3
---

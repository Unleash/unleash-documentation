...
description: "Deploy Unleash with Docker: set up self-hosted Open Source or Enterprise, start the server, log in, and test it."
max-toc-depth: 3
...
<Frame>
![Unleash Admin UI log in screen](/assets/quickstart-login.png)
</Frame>

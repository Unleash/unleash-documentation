...
Set the public URL where your Unleash Enterprise Edge can be accessed using the environment variable `EDGE_URL`. For example, `https://yourcompany.edge.getunleash.io`. This URL is then shown in the API access API URLs to make it easy for your team to connect to Edge.

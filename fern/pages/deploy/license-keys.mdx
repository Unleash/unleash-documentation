---
title: License keys
og:title: License keys
og:site_name: Unleash
description: "Set up Unleash Enterprise license keys for self-hosted deployments, activation, renewal, refresh, removal, and offline use."
---

<Button small outlined className="version-button" href="/support/availability">v5.8</Button> <Button small href="https://www.getunleash.io/plans" className="cta-button">Enterprise</Button>
...
<Button small outlined className="version-button" href="/support/availability">v6.7</Button>

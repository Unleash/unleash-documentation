...
og:title: Unleash hosting options
...
<Frame>
![An architecture diagram of Enterprise Edge](/assets/hosting-cloud-hosted.png)
</Frame>
...
<Frame>
![An architecture diagram of using Edge in a setup where Unleash hosts the API and you host the Edge.](/assets/hosting-hybrid.png)
</Frame>
...
<Frame>
![An architecture diagram of using the Edge in a single-region, self-hosted setup.](/assets/hosting-self-hosted.png)
</Frame>

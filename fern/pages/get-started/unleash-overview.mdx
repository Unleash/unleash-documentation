...
description: Learn how Unleash's architecture provides fast, secure, and reliable feature flag evaluations with SDKs, APIs, and Edge components.
keywords: unleash architecture, feature flags, sdks, unleash edge, api, system design, evaluation
og:site_name: Unleash Documentation
og:title: Unleash Architecture Overview - Fast and Secure Feature Flags
max-toc-depth: 3
---
...
<Frame background="subtle">
  ![A visual overview of an Unleash system as described in the following paragraph.](/assets/unleash-architecture.png)
</Frame>
...
<Frame background="subtle">
  ![A visual overview of an Unleash system as described in the following paragraph.](/assets/unleash-admin-ui.png)
</Frame>

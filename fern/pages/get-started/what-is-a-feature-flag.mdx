...
keywords: feature flags, feature toggles, progressive rollouts, trunk-based development, a/b testing, kill switches
...
- Feature flags turn features on or off at runtime without touching source code or redeploying.
...
Next, let's look at some of the common use cases for feature flags, such as [progressive rollouts](https://www.getunleash.io/feature-flag-use-cases-progressive-or-gradual-rollouts), [A/B testings](https://www.getunleash.io/blog/ab-testing-feature-flags-how-to), kill switches, and more.

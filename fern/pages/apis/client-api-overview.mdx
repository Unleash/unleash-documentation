...
The Client API is designed for [backend SDKs](/sdks/node) and [Unleash Edge](/unleash-edge/overview) to fetch feature flag configurations. This API returns all [feature flags](/concepts/feature-flags) and [activation strategies](/concepts/activation-strategies) for server-side evaluation.
...
[Unleash Enterprise Edge](/unleash-edge/overview) uses the Client API to stay synchronized with your Unleash instance. Edge provides:

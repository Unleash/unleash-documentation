...
|---------------|----|-----|---|
| [Client API](#client-api) | `<your-unleash-url>/api/client` | Backend SDKs | Fetch feature flag configurations. |
| [Frontend API](#frontend-api) | `<your-unleash-url>/api/frontend` | Frontend SDKs | Fetch enabled feature flags for a specific Unleash Context. |
| Admin API | `<your-unleash-url>/api/admin` | Admin UI, internal tooling, and third-party integrations | Access and manage all resources within Unleash, such as context, environments, events, metrics, and users. |

...
description: "Set up Google SSO for Unleash: configure OAuth client credentials, redirect URI, auto-created users, and verify sign-in."
og:site_name: Unleash Docs
og:title: Set up SSO with Google
keywords: SSO, Google, single sign-on, authentication, deprecated
max-toc-depth: 3
slug: single-sign-on/how-to-add-sso-google
...
![sso-config](/assets/sso-configure.png)
</Frame>
...
<Frame background="subtle">
![Verify SSO](/assets/sign-in-google.png)
</Frame>

...
description: "Set up SAML SSO for Unleash with Keycloak: configure the SAML client, entity ID, X.509 certificate, login URL, and users."
og:site_name: Unleash Docs
og:title: Set up SSO with SAML 2.0 and Keycloak
keywords: SSO, SAML, Keycloak, single sign-on, authentication
max-toc-depth: 3
slug: single-sign-on/how-to-add-sso-saml-keycloak
---

...
description: "Set up SAML SSO for Unleash with Microsoft Entra ID: configure claims, certificates, login URLs, testing, and group sync."
og:site_name: Unleash Docs
og:title: Set up SSO with SAML 2.0 and Microsoft Entra ID
keywords: SSO, SAML, Microsoft Entra ID, Azure AD, single sign-on, authentication
max-toc-depth: 3
slug: single-sign-on/how-to-add-sso-azure-saml
---
...
![SAML configuration in Microsoft Entra admin center](/assets/microsoft-entra-claims.png)
</Frame>
...
<Frame background="subtle">
![X509 Certificate from the SAML certificate XML file](/assets/x509cert.png)
</Frame>
...
<Frame background="subtle">
![Configure SAML 2.0 in Unleash](/assets/saml2.0.png)
</Frame>

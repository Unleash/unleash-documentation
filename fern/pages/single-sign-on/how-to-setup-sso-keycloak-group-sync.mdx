---
title: Set up user group syncing with Keycloak
description: Configure OIDC Single Sign-On (SSO) in Keycloak and automatically sync user group membership to Unleash.
og:site_name: Unleash Docs
og:title: Set up user group syncing with Keycloak
keywords: SSO, Keycloak, group sync, user groups, OIDC, OpenID Connect
max-toc-depth: 3
slug: single-sign-on/how-to-setup-sso-keycloak-group-sync
---
...
![The Keycloak Admin UI with the steps highlighted to navigate to client configuration.](/assets/setup-keycloak-sync-1.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak Admin UI with the client configuration open.](/assets/setup-keycloak-sync-2.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak client configuration with redirect URIs highlighted.](/assets/setup-keycloak-sync-3.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak credentials configuration with copy client secret highlighted.](/assets/setup-keycloak-sync-4.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak realm settings the OpenID endpoint configuration link highlighted.](/assets/setup-keycloak-sync-5.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak Client Scopes page with the Create Client Scope button highlighted.](/assets/setup-keycloak-sync-6.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak Add Client Scope page with the Name, Type, Protocol and Include in Token Response fields highlighted.](/assets/setup-keycloak-sync-7.png)
</Frame>

Navigate to the Mappers tab and select "Configure new Mapper".

<Frame background="subtle">
![The Keycloak Client Scope details page with the Mappers tab and Configure new Mapper element highlighted.](/assets/setup-keycloak-sync-8.png)
</Frame>

Select the Group Membership mapper.

<Frame background="subtle">
![The Keycloak mapper popup with the Group Membership mapper highlighted.](/assets/setup-keycloak-sync-9.png)
</Frame>
...
<Frame background="subtle">
![The Keycloak mapper options screen with the Token Claim Name and Full Group Path elements highlighted.](/assets/setup-keycloak-sync-10.png)
</Frame>
...
<Frame background="subtle">
![The Unleash SSO configuration screen with Client ID, Client Secret and Discover URL highlighted.](/assets/setup-keycloak-sync-11.png)
</Frame>
...
<Frame background="subtle">
![The Unleash SSO configuration screen with the Enable Group Syncing and Group Field JSON Path highlighted.](/assets/setup-keycloak-sync-12.png)
</Frame>
...
<Frame background="subtle">
![The Groups page with a group element highlighted.](/assets/setup-keycloak-sync-13.png)
</Frame>

Edit the group.

<Frame background="subtle">
![The Group page with the Edit group element highlighted.](/assets/setup-keycloak-sync-14.png)
</Frame>

Add as many SSO groups as you like. These need to match the Keycloak groups exactly.

<Frame background="subtle">
![The edit group page with the add SSO group element highlighted.](/assets/setup-keycloak-sync-15.png)
</Frame>

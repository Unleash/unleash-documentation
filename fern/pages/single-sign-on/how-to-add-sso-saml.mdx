...
description: "Set up SAML SSO for Unleash with Okta: create the app, configure SAML 2.0, map attributes, and verify sign-in."
og:site_name: Unleash Docs
og:title: Set up SSO with SAML 2.0 and Okta
keywords: SSO, SAML, Okta, single sign-on, authentication
max-toc-depth: 3
slug: single-sign-on/how-to-add-sso-saml
...
![sso-config](/assets/sso-configure-saml.png)
</Frame>
...
<Frame background="subtle">
![Unleash: SAML 2.0](/assets/sso-saml-unleash.png)
</Frame>
...
<Frame background="subtle">
![SAML 2.0 Okta edit](/assets/sso-saml-okta-edit.png)
</Frame>
...
<Frame background="subtle">
![SAML 2.0 Okta sign-out config](/assets/sso-saml-okta-signout.png)
</Frame>
...
<Frame background="subtle">
![SAML 2.0 Okta sign-out url](/assets/sso-saml-okta-signout-url.png)
</Frame>
...
<Frame background="subtle">
![SAML 2.0 Okta sign-out config](/assets/sso-saml-okta-signout-unleash.png)
</Frame>

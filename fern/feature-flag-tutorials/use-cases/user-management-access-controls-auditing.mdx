...
description: "Feature flags are a game-changer for how software teams build, test, and release products. They enable you to roll out new features with confidence, manage risk, and keep your software development agile and secure."
---
...
## Implement single sign-on for enterprise identity integration[​](#implement-single-sign-on-for-enterprise-identity-integration "Direct link to Implement single sign-on for enterprise identity integration")
...
![In Unleash\&#39;s Single Sign-On page, there are four tabs to set up Open ID Connect, SAML 2.0, traditional passwords, and SCIM.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-saml-7292ad6ed51af6c9233ef91e211ddec6.png)

When you connect Unleash to your identity provider, you can synchronize user groups with the identity provider. That way, the synchronization process becomes automated so your group configuration reflects organizational changes. Follow our step-by-step guide to set up [user group syncing](/how-to/how-to-set-up-group-sso-sync). With SSO integration, groups defined in your identity provider are directly mapped to Unleash access groups. This means:
...
![The password tab has a toggle that you can turn off.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-disable-password-login-fd58165fb2ced4d53bf3ce719d8bd8ad.png)
...
## Automate user management at scale[​](#automate-user-management-at-scale "Direct link to Automate user management at scale")
...
SCIM takes group synchronization to the next level by providing a standardized protocol for user and group management. Through SCIM, you can:
...
![Turn the SCIM provisioning toggle on to enable SCIM.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-scim-protocol-840702f4caf0fb9097c6fbb4f50d6dfd.png)
...
## Configure role-based access controls for feature flags[​](#configure-role-based-access-controls-for-feature-flags "Direct link to Configure role-based access controls for feature flags")
...
![Manage all user roles in the Unleash Admin UI.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-root-roles-07a63f1e19ba69457dc908fd9d86b448.png)
...
Editors can perform the same operations as admins, *except* managing users and roles. Editors can operate as project owners.
...
![In the \&quot;New root role\&quot; form, name your role, add a description, and select permissions in each dropdown section in the form.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-custom-role-f9599384fdfa2d082cb6ebddf202d2ac.png)

### Extend RBAC with a change management workflow[​](#extend-rbac-with-a-change-management-workflow "Direct link to Extend RBAC with a change management workflow")
...
![You can view the list of change requests with their relevant metadata.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-change-requests-40f15d7f20eed74df3c10c6a41ace4ab.png)
...
![This GIF shows how to quickly make changes to your feature flag, request the change, approve it, and apply the changes.](../../images/feature-flag-tutorials/use-cases/assets/images//use-case-user-mgmt-cr-cf2df5e3783ca9d6ef824c8253dbb63e.gif)
...
## Implement effective auditing in Unleash[​](#implement-effective-auditing-in-unleash "Direct link to Implement effective auditing in Unleash")
...
### Auditing user actions[​](#auditing-user-actions "Direct link to Auditing user actions")
...
![This event log captures a change request cancellation, the user who performed the cancellation, and other metadata.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-user-mgmt-event-log-27eee9daebc7453c51a7e7f4bc28ed75.png)
...
```
{    "timestamp": "2024-03-15T14:22:11Z",    "user": {        "id": "user-123",        "email": "jane.developer@company.com"    },    "action": "feature_flag_updated",    "details": {        "flag_name": "payment-gateway-experiment",        "previous_state": "enabled",        "new_state": "disabled",        "environment": "production"    },    "source_ip": "192.168.1.100"}
```
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/feature-flag-tutorials/use-cases/user-management-access-controls.md)

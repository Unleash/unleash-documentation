...
description: "Feature flags are a great way to run A/B or multivariate tests with minimal code modifications, and Unleash offers built-in features that make it easy to get started. In this tutorial, we will walk through how to do an A/B test using Unleash with your application."
---

## How to perform A/B testing with feature flags[​](#how-to-perform-ab-testing-with-feature-flags "Direct link to How to perform A/B testing with feature flags")
...
![Create a new feature flag in the Unleash Admin UI.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-new-flag-12480e6ebbd3fe8daf0a5e4623c4f0f7.png)
...
![Create a feature flag by filling out the form fields.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-create-experiment-flag-de254ada633a69b2986ae3ad8e7c1340.png)
...
### Target users for A/B testing[​](#target-users-for-ab-testing "Direct link to Target users for A/B testing")
...
![Anatomy of an activation strategy](../../images/feature-flag-tutorials/use-cases/assets/images/anatomy-of-unleash-strategy-03ead043c7db3c44c7021aae7749b7a0.png)
...
![Add your first strategy from the flag view in Unleash.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-experiment-add-strategy-240e40cf7095d21228882129988d0bb9.png)
...
![In the gradual rollout form, you can configure the parameters of your A/B tests and releases.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-experiment-gradual-rollout-12a267da93365bf7c0bb876a69e73685.png)
...
![This diagram breaks down how strategy variants sit on top activation strategies for flags in Unleash.](../../images/feature-flag-tutorials/use-cases/assets/images/tutorial-building-blocks-strategy-variants-5c33f5120ad572aa709f97c350963161.png)
...
![You can configure multiple strategy variants for A/B testing within the gradual rollout form.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-experiment-variants-4ced8005a835e7f4c5d59f57a1afd842.png)

### Manage user session behavior[​](#manage-user-session-behavior "Direct link to Manage user session behavior")
...
### Track A/B testing for your key performance metrics[​](#track-ab-testing-for-your-key-performance-metrics "Direct link to Track A/B testing for your key performance metrics")
...
![Enable impression data in the strategy rollout form for your flag.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-experiment-enable-impression-data-ad2af69904a9723f13654cfdcccef05d.png)
...
```
{    "eventType": "getVariant",    "eventId": "c41aa58b-d2c7-45cf-b668-7267f465e01a",    "context": {        "sessionId": 386689528,        "appName": "my-example-app",        "environment": "default"    },    "enabled": true,    "featureName": "ab-testing-example",    "impressionData": true,    "variant": "variantA"}
```
...
```
unleash.on(UnleashEvents.Impression, (e: ImpressionEvent) => {    // send to google analytics, something like    gtag("event", "screen_view", {        app_name: e.context.appName,        feature: e.featureName,        treatment: e.enabled ? e.variant : "Control", // in case we use feature disabled for control    });});
```

Example 2

```
unleash.on(UnleashEvents.Impression, (e: ImpressionEvent) => {    if (e.enabled) {        // send to google analytics, something like        gtag("event", "screen_view", {            app_name: e.context.appName,            feature: e.featureName,            treatment: e.variant, // in case we use a variant for the control treatment        });    }});
```
...
```
{    "client_id": "unleash_client"    "user_id": "uuid1234"    "timestamp_micros": "1730407349525000"    "non_personalized_ads": true    "events": [        {            "name":"select_item"            "params": {                "items":[]                "event":"screen_view"                "app_name":"myAppName"                "feature":"myFeatureName"                "treatment":"variantValue"            }        }    ]}
```
...
### Roll out the winning variant to all users[​](#roll-out-the-winning-variant-to-all-users "Direct link to Roll out the winning variant to all users")
...
## A/B testing with enterprise automation[​](#ab-testing-with-enterprise-automation "Direct link to A/B testing with enterprise automation")
...
### Multi-arm bandit tests to find the winning variant[​](#multi-arm-bandit-tests-to-find-the-winning-variant "Direct link to Multi-arm bandit tests to find the winning variant")
...
![This is a graph comparing traditional A/B testing and multi-arm bandit selection.](../../images/feature-flag-tutorials/use-cases/assets/images/use-case-ab-testing-vs-bandit-0a20754986aa2621a6c3177c7dc8864c.png)
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/feature-flag-tutorials/use-cases/a-b-testing.md)

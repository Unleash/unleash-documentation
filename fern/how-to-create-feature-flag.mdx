...
## Add an activation strategy[​](#add-an-activation-strategy "Direct link to Add an activation strategy")
...
## Enable the feature flag in an environment[​](#enable-the-feature-flag-in-an-environment "Direct link to Enable the feature flag in an environment")
...
## Refine targeting with constraints and segments[​](#refine-targeting-with-constraints-and-segments "Direct link to Refine targeting with constraints and segments")
...
### Configure strategy variants[​](#configure-strategy-variants "Direct link to Configure strategy variants")
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/feature-flag-tutorials/use-cases/how-to-create-feature-toggles.md)

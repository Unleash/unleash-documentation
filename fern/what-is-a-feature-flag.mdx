...
## Why developers use feature flags[​](#why-developers-use-feature-flags "Direct link to Why developers use feature flags")
...
## What is a feature flag?[​](#what-is-a-feature-flag "Direct link to What is a feature flag?")
...
![Diagram demonstrating the relationship between a CI/CD pipeline, an application, and its feature flags](images/assets/images/how-feature-flags-work-8cb3a78f3a23e35281dc5cca78db9a24.png).

## Benefits of feature flags[​](#benefits-of-feature-flags "Direct link to Benefits of feature flags")
...
### Improve user experience[​](#improve-user-experience "Direct link to Improve user experience")
...
### Level up your QA[​](#level-up-your-qa "Direct link to Level up your QA")
...
### Reduce risk[​](#reduce-risk "Direct link to Reduce risk")
...
### Speed up release cycles[​](#speed-up-release-cycles "Direct link to Speed up release cycles")
...
### Enable testing and experimenting[​](#enable-testing-and-experimenting "Direct link to Enable testing and experimenting")
...
## Feature flags vs. feature branches[​](#feature-flags-vs-feature-branches "Direct link to Feature flags vs. feature branches")
...
### Do you still need feature flags if you use feature branches?[​](#do-you-still-need-feature-flags-if-you-use-feature-branches "Direct link to Do you still need feature flags if you use feature branches?")
...
## Implementing feature flags[​](#implementing-feature-flags "Direct link to Implementing feature flags")
...
![XKCD comic. Source: https://imgs.xkcd.com/comics/the\_wrong\_stuff.png](images/assets/images/xkcd-comic-spaceship-f38910b17144a3518a4c602508a3645a.png)
...
## Types of feature flags[​](#types-of-feature-flags "Direct link to Types of feature flags")
...
![Pete Hodgson’s taxonomy of feature flag types. Source: https://martinfowler.com/articles/feature-toggles.html](images/assets/images/feature-flag-lifecycle-chart-1af0a5c9cbab0d070b2543c4f6c92587.png)

### Release flags[​](#release-flags "Direct link to Release flags")
...
### Experiment flags[​](#experiment-flags "Direct link to Experiment flags")
...
### Kill switches[​](#kill-switches "Direct link to Kill switches")
...
### Operational flags[​](#operational-flags "Direct link to Operational flags")
...
## Use cases for feature flags[​](#use-cases-for-feature-flags "Direct link to Use cases for feature flags")
...
### Progressive rollouts[​](#progressive-rollouts "Direct link to Progressive rollouts")
...
### Kill switches[​](#kill-switches-1 "Direct link to Kill switches")
...
### Trunk-based development​[​](#trunk-based-development "Direct link to Trunk-based development​")
...
### Compliance with FedRAMP, SOC 2, ISO27001, Air-gap, and others[​](#compliance-with-fedramp-soc-2-iso27001-air-gap-and-others "Direct link to Compliance with FedRAMP, SOC 2, ISO27001, Air-gap, and others")
...
## Applying feature flag best practices with Unleash[​](#applying-feature-flag-best-practices-with-unleash "Direct link to Applying feature flag best practices with Unleash")
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/topics/what-is-a-feature-flag.mdx)

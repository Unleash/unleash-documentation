...
description: "Feature flags, , are a powerful software development technique that allows engineering teams to decouple the release of new functionality from software deployments."
---
...
### Feature flag system components[​](#feature-flag-system-components "Direct link to Feature flag system components")
...
* **API layer**: An API layer that exposes endpoints for your application to interact with the *Feature Flag Control Service*. [This API should allow your application to request feature flag configurations](/understanding-unleash/unleash-overview).
...
* **Continuous update mechanism**: An update mechanism that enables [dynamic updates to feature flag configurations](/understanding-unleash/unleash-overview) without requiring application restarts or redeployments. The SDK should handle subscriptions or polling to the *Feature Flag Control Service* for updates.

![The SDK holds an in-memory feature flag configuration cache which is continuously synced with the Feature Flag Control Service. You can then use the SDK to check the state of feature flags in your application.](../../images/topics/feature-flags/assets/images/feature-flag-scalable-architecture-0ed218a3d6237eff2bf6d6f3e9224046.png)

## 2. Make flags short-lived[​](#2-make-flags-short-lived "Direct link to 2. Make flags short-lived")
...
| Example use cases             | * Database or server credentials
* Server port
* CORS headers
* API base URL | - [A/B or multivariate testing](https://www.getunleash.io/blog/ab-testing-feature-flags-how-to)
...
### Strategies for large organizations implementing feature flags[​](#strategies-for-large-organizations-implementing-feature-flags "Direct link to Strategies for large organizations implementing feature flags")
...
## 3. Prioritize availability over consistency[​](#3-prioritize-availability-over-consistency "Direct link to 3. Prioritize availability over consistency")
...
Ensure that all flags within the same *Feature Flag Control Service* have unique names across your entire system. [Unique naming](https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale#13-never-reuse-feature-flag-names) prevents the reuse of old flag names, reducing the risk of accidentally re-enabling outdated features with the same name.

![Creating a feature flag with a unique name referencing the project and related jira ticket.](../../images/topics/feature-flags/assets/images/feature-flag-unique-name-b422f83f0809e54965ef942609d81a46.png)

### The benefits of unique naming[​](#the-benefits-of-unique-naming "Direct link to The benefits of unique naming")
...
![Preview of a change request to enable gradual rollout in production.](../../images/topics/feature-flags/assets/images/feature-flag-change-requests-preview-0592a0b9c6bfe3263388be7a4103b2c8.png)

### Open collaboration strategies for feature flag management[​](#open-collaboration-strategies-for-feature-flag-management "Direct link to Open collaboration strategies for feature flag management")
...
![Evaluating flags on the server side without exposing sensitive information.](../../images/topics/feature-flags/assets/images/feature-flag-server-side-evaluation-e75998b6664acb37366b130754edf245.png)
...
### Evaluate within a self-hosted environment[​](#evaluate-within-a-self-hosted-environment "Direct link to Evaluate within a self-hosted environment")
...
![In client-side setups, perform the feature flag evaluation on the server side. Connected client-side applications receive only evaluated feature flags to avoid leaking configuration.](../../images/topics/feature-flags/assets/images/feature-flag-architecture-client-side-20b3987453c69be5e1cd57a46ab8a40d.png)
...
![YouTube video player 1 thumbnail](../../images/topics/feature-flags/vi/mCXSAWzdn3I/hqdefault.jpg)
...
![Separating the reading and writing of the database allows you to horizontally scale out the read APIs without scaling the write APIs.](../../images/topics/feature-flags/assets/images/feature-flag-horizontal-scaling-64c9595b1f4de4f8c633f6190cda082f.png)
...
### The benefits of decoupling[​](#the-benefits-of-decoupling "Direct link to The benefits of decoupling")
...
### The benefits of small payloads[​](#the-benefits-of-small-payloads "Direct link to The benefits of small payloads")
...
### Strategies for consistency in percentage-based gradual rollouts[​](#strategies-for-consistency-in-percentage-based-gradual-rollouts "Direct link to Strategies for consistency in percentage-based gradual rollouts")
...
### Developer experience strategies for feature flags[​](#developer-experience-strategies-for-feature-flags "Direct link to Developer experience strategies for feature flags")
...
Thank you for reading. Our motivation for writing these principles is to share what we've learned building a [large-scale feature flag solution](https://www.getunleash.io/enterprise-feature-management-platform) with other architects and engineers solving similar challenges. [Unleash is open-source](https://www.getunleash.io/open-source), and so are these principles. Have something to contribute? [Open a PR](https://github.com/Unleash/unleash/pulls) or [discussion](https://github.com/orgs/Unleash/discussions) on our GitHub.

To learn more about Unleash architecture and implementation basics, check out this webinar:

![YouTube video player 1 thumbnail](../../images/topics/feature-flags/vi/_kYAQsuTtqQ/hqdefault.jpg)

Click to load video

### Best practices for deploying Unleash at scale[​](#best-practices-for-deploying-unleash-at-scale "Direct link to Best practices for deploying Unleash at scale")

An introduction to Unleash Edge product and its scaling capabilities:

![YouTube video player 1 thumbnail](../../images/topics/feature-flags/vi/6uIdF-yByWs/hqdefault.jpg)

Click to load video

[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/topics/feature-flags/feature-flag-best-practices.mdx)

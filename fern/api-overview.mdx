...
## API authentication and tokens[​](#api-authentication-and-tokens "Direct link to API authentication and tokens")
...
![Diagram showing the types of tokens needed to connect a frontend SDK with Edge, and Edge with Unleash](images/assets/images/sdk-token-example-684fe26c1a8b994642abdf76eaa26088.jpg)
...
<Note>
  **Unleash version**: `5.2+` enabled by default. **Unleash version**: `4.13+` can be enabled using the `ENABLE_OAS` [environment variable](/using-unleash/deploy/configuring-unleash).
</Note>
...
[Edit this page](https://github.com/Unleash/unleash/edit/main/website/docs/api-overview.mdx)
